...
public class GasCentrifugeRecipeCategory implements IRecipeCategory<PsuedoGasCentrifugeRecipe> {
    ...
    public void draw(PsuedoGasCentrifugeRecipe recipe, PoseStack matrixStack, double mouseX, double mouseY) {
		...
		TranslatableComponent indivU235String = new TranslatableComponent("gui.jei.category." + RECIPE_GROUP + ".info.indiv_u235",
			animTimeSeconds);

		TranslatableComponent indivU238String = new TranslatableComponent("gui.jei.category." + RECIPE_GROUP + ".info.indiv_u238",
			animTimeSeconds);
