...
public enum QuantumTunnelTextures implements ITexture {
    ...
    FREQUENCY_SELECTED(18, 18, 0, 0, 18, 18,
	    NuclearScience.rl("textures/screen/component/quantumtunnel/frequencyselected.png"));
    ...
    private QuantumTunnelTextures(int textureWidth, int textureHeight, int textureU, int textureV, int imageWidth,
