...
public class WrapperQuantumTunnelFrequencies {
	...
	box = new ScreenComponentFillArea(x + 5, y + 24, 120, 10, new Color(112, 112, 112, 255),
	...
	disable = (ScreenComponentButton<?>) new ScreenComponentButton<>(x + 150, y + 19, 20, 20).setOnPress(but -> {
		...
		NuclearTextUtils.gui("quantumtunnel.disable"), xAxis, yAxis)).setIcon(NuclearIconTypes.DISABLE);
	...
	for (int i = 0; i < BUTTON_COUNT; i++) {
	    frequencyButtons[i] = new ButtonTunnelFrequency(x + butOffX, y + butOffY + 25 * i, 110, 25)
		    .setOnPress(but -> {
	...
	for (int i = 0; i < BUTTON_COUNT; i++) {
	    ...
	    editButtons[i] = (ScreenComponentButton) new ScreenComponentButton<>(x + butOffX + 111,
			...
			updateVisibility(false);
			    ...
			    NuclearTextUtils.gui("quantumtunnel.edit"), xAxis, yAxis))
	...
	for (int i = 0; i < BUTTON_COUNT; i++) {
	    ...
	    deleteButtons[i] = (ScreenComponentButton) new ScreenComponentButton<>(x + butOffX + 132,
		    y + 2 + butOffY + 25 * i, 20, 20).setOnPress(but -> {
