...
public class ButtonIO extends ScreenComponentButton<ButtonIO> {
    ...
    public void renderBackground(PoseStack poseStack, int xAxis, int yAxis, int guiWidth, int guiHeight) {
        ...
        fill(poseStack, xLocation + guiWidth + 1, yLocation + guiHeight + 1, xLocation + guiWidth + 1 + DRAWING_AREA_SIZE, yLocation + guiHeight + 1 + DRAWING_AREA_SIZE, ioColor.color());
