...
public class ScreenComponentGasCentrifuge extends ScreenComponentGeneric {
    ...
    private static final ResourceLocation TEXTURE = NuclearScience
	    .rl("textures/screen/component/nsprocessingarrows.png");
    ...
    public ScreenComponentGasCentrifuge(DoubleSupplier progressInfoHandlerBulbs,
	    DoubleSupplier progressInfoHandlerProgressTop, DoubleSupplier progressInfoHandlerProgressMiddle,
	    DoubleSupplier progressInfoHandlerProgressBottom, int x, int y) {
	...
	graphics.blit(texture.getLocation(), guiWidth + xLocation, guiHeight + yLocation + 3, texture.textureU(),
		texture.textureV(), progressBulbs, texture.textureHeight(), texture.imageWidth(),
		texture.imageHeight());
	...
	graphics.blit(texture.getLocation(), guiWidth + xLocation + 72, guiHeight + yLocation, texture.textureU(),
		texture.textureV(), topProgress, texture.textureHeight(), texture.imageWidth(), texture.imageHeight());
	graphics.blit(texture.getLocation(), guiWidth + xLocation + 72, guiHeight + yLocation + 20, texture.textureU(),
		texture.textureV(), middleProgress, texture.textureHeight(), texture.imageWidth(),
		texture.imageHeight());
	graphics.blit(texture.getLocation(), guiWidth + xLocation + 72, guiHeight + yLocation + 41, texture.textureU(),
		texture.textureV(), bottomProgress, texture.textureHeight(), texture.imageWidth(),
		texture.imageHeight());
	...
	GasCentrifugeTextures(int textureWidth, int textureHeight, int textureU, int textureV, int imageWidth,
		int imageHeight) {
