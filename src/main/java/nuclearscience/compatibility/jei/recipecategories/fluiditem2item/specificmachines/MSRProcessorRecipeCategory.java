...
public class MSRProcessorRecipeCategory extends FluidItem2ItemRecipeCategory<MSRFuelPreProcessorRecipe> {
    ...
    public static final ItemSlotObject INPUT_SLOT_1 = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 58, 2,
	    RecipeIngredientRole.INPUT);
    public static final ItemSlotObject INPUT_SLOT_2 = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 58, 23,
	    RecipeIngredientRole.INPUT);
    public static final ItemSlotObject INPUT_SLOT_3 = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 58, 44,
	    RecipeIngredientRole.INPUT);
    public static final ItemSlotObject OUTPUT_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 107, 23,
	    RecipeIngredientRole.OUTPUT);
    public static final ItemSlotObject INPUT_BUCKET_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL,
	    ScreenComponentSlot.IconType.FLUID_DARK, 27, 36, RecipeIngredientRole.INPUT);
    ...
    public static final ArrowAnimatedObject ANIM_RIGHT_ARROW_2 = new ArrowAnimatedObject(
	    ScreenComponentProgress.ProgressBars.PROGRESS_ARROW_RIGHT, 80, 24, StartDirection.LEFT);
    ...
    public static final RecipeType<MSRFuelPreProcessorRecipe> RECIPE_TYPE = RecipeType.create(NuclearScience.ID,
	    MSRFuelPreProcessorRecipe.RECIPE_GROUP, MSRFuelPreProcessorRecipe.class);

    public MSRProcessorRecipeCategory(IGuiHelper guiHelper) {
	super(guiHelper, NuclearTextUtils.jeiTranslated(MSRFuelPreProcessorRecipe.RECIPE_GROUP), INPUT_MACHINE,
