...
public class ChemicalExtractorRecipeCategory extends FluidItem2ItemRecipeCategory<ChemicalExtractorRecipe> {
	...
	public static final ItemSlotObject INPUT_BUCKET_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, ScreenComponentSlot.IconType.FLUID_DARK, 57, 36, true);
	public static final ItemSlotObject OUTPUT_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 107, 16, false);
	...
	public static final RecipeType<ChemicalExtractorRecipe> RECIPE_TYPE = RecipeType.create(NuclearScience.ID, ChemicalExtractorRecipe.RECIPE_GROUP, ChemicalExtractorRecipe.class);
