...
public class ChemicalExtractorRecipeCategory extends FluidItem2ItemRecipeCategory<ChemicalExtractorRecipe> {
    ...
    public static final RecipeType<ChemicalExtractorRecipe> RECIPE_TYPE = RecipeType.create(NuclearScience.ID,
	    ChemicalExtractorRecipe.RECIPE_GROUP, ChemicalExtractorRecipe.class);

    public ChemicalExtractorRecipeCategory(IGuiHelper guiHelper) {
	super(guiHelper, NuclearTextUtils.jeiTranslated(ChemicalExtractorRecipe.RECIPE_GROUP), INPUT_MACHINE, BACK_WRAP,
