...
import voltaic.compatibility.jei.recipecategories.fluiditem2gas.FluidItem2GasRecipeCategory;
...
public class NuclearBoilerRecipeCategory extends FluidItem2GasRecipeCategory<NuclearBoilerRecipe> {
    ...
    public static final RecipeType<NuclearBoilerRecipe> RECIPE_TYPE = RecipeType.create(NuclearScience.ID,
	    NuclearBoilerRecipe.RECIPE_GROUP, NuclearBoilerRecipe.class);

    public NuclearBoilerRecipeCategory(IGuiHelper guiHelper) {
	super(guiHelper, NuclearTextUtils.jeiTranslated(NuclearBoilerRecipe.RECIPE_GROUP), INPUT_MACHINE, BACK_WRAP,
