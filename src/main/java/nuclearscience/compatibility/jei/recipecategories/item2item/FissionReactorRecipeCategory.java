...
public class FissionReactorRecipeCategory extends Item2ItemRecipeCategory<FissionReactorRecipe> {
	...
	public static final ItemSlotObject INPUT_SLOT = new ItemSlotObject(SlotType.NORMAL, 57, 25, true);
	public static final ItemSlotObject CELL_SLOT_1 = new ItemSlotObject(SlotType.NORMAL, 15, 15, true);
	public static final ItemSlotObject CELL_SLOT_2 = new ItemSlotObject(SlotType.NORMAL, 15, 99, true);
	public static final ItemSlotObject CELL_SLOT_3 = new ItemSlotObject(SlotType.NORMAL, 99, 15, true);
	public static final ItemSlotObject CELL_SLOT_4 = new ItemSlotObject(SlotType.NORMAL, 99, 99, true);
	public static final ItemSlotObject OUTPUT_SLOT = new ItemSlotObject(SlotType.NORMAL, 57, 89, false);
