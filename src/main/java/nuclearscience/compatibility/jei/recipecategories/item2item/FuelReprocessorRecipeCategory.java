...
public class FuelReprocessorRecipeCategory extends Item2ItemRecipeCategory<FuelReprocessorRecipe> {
    ...
    public static final BiproductPercentWrapperElectroRecipe ITEM_LABEL = new BiproductPercentWrapperElectroRecipe(100,
	    40, BiproductPercentWrapperElectroRecipe.BiproductType.ITEM, 1);
    ...
    public static final RecipeType<FuelReprocessorRecipe> RECIPE_TYPE = RecipeType.create(NuclearScience.ID,
	    FuelReprocessorRecipe.RECIPE_GROUP, FuelReprocessorRecipe.class);

    public FuelReprocessorRecipeCategory(IGuiHelper guiHelper) {
	super(guiHelper, NuclearTextUtils.jeiTranslated(FuelReprocessorRecipe.RECIPE_GROUP), INPUT_MACHINE, BACK_WRAP,
