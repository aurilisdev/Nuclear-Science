...
public class NuclearBoilerRecipeCategory extends FluidItem2FluidRecipeCategory<NuclearBoilerRecipe> {
	...
	public static final RecipeType<NuclearBoilerRecipe> RECIPE_TYPE = RecipeType.create(NuclearScience.ID, NuclearBoilerRecipe.RECIPE_GROUP, NuclearBoilerRecipe.class);
