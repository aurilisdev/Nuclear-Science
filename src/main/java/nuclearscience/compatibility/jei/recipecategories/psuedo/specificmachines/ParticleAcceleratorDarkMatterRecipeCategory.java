...
public class ParticleAcceleratorDarkMatterRecipeCategory extends AbstractRecipeCategory<PsuedoItem2ItemRecipe> {
	...
	@Override
	public void drawPre(PoseStack poseStack, PsuedoItem2ItemRecipe recipe) {
		...
		Screen.blit(poseStack, 28, 28, texture.textureU(), texture.textureV(), texture.textureWidth(), texture.textureHeight(), texture.imageWidth(), texture.imageHeight());
