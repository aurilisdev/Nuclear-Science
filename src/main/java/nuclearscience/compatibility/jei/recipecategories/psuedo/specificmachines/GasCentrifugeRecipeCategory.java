...
public class GasCentrifugeRecipeCategory extends AbstractRecipeCategory<PsuedoGasCentrifugeRecipe> {
    ...
    public static final ScreenObject GASCENTRIFUGE_ARROW_STATIC = new ScreenObject(
	    NuclearJeiTextures.GASCENTRIFUGE_ARROW_STATIC, 19, 5);

    public static final ItemSlotObject OUTPUT_SLOT_1 = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 113, 2,
	    RecipeIngredientRole.OUTPUT);
    public static final ItemSlotObject OUTPUT_SLOT_2 = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 113, 22,
	    RecipeIngredientRole.OUTPUT);
    public static final ItemSlotObject BIPRODUCT_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 113, 42,
	    RecipeIngredientRole.OUTPUT);

    public static final ArrowAnimatedObject ANIM_RIGHT_ARROW = new ArrowAnimatedObject(
	    NuclearJeiTextures.GASCENTRIFUGE_ARROW_OFF, NuclearJeiTextures.GASCENTRIFUGE_ARROW_ON, 64, 4,
	    StartDirection.LEFT);

    public static final GasGaugeObject IN_GAUGE = new GasGaugeObject(2, 6);

    public static final LabelWrapperGeneric U235 = new LabelWrapperGeneric(LABEL_COLOR, 7, 36, false,
	    ChatFormatter.getChatDisplayShort(TileGasCentrifuge.PERCENT_U235 * 100, DisplayUnits.PERCENTAGE));
    public static final LabelWrapperGeneric U238 = new LabelWrapperGeneric(LABEL_COLOR, 28, 36, false,
	    ChatFormatter.getChatDisplayShort((1 - TileGasCentrifuge.PERCENT_U235) * 100, DisplayUnits.PERCENTAGE));
    public static final LabelWrapperGeneric BIPROD = new LabelWrapperGeneric(LABEL_COLOR, 49, 36, false,
    ...
    public static final RecipeType<PsuedoGasCentrifugeRecipe> RECIPE_TYPE = RecipeType.create(NuclearScience.ID,
	    RECIPE_GROUP, PsuedoGasCentrifugeRecipe.class);
