...
public class GasCentrifugeRecipeCategory extends AbstractRecipeCategory<PsuedoGasCentrifugeRecipe> {
	...
	public static final ItemSlotObject OUTPUT_SLOT_1 = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 113, 2, false);
	public static final ItemSlotObject OUTPUT_SLOT_2 = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 113, 22, false);
	public static final ItemSlotObject BIPRODUCT_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 113, 42, false);
	...
	public static final FluidGaugeObject IN_GAUGE = new FluidGaugeObject(2, 6);
