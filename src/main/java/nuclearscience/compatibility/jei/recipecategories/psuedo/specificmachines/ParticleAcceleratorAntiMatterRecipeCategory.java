...
public class ParticleAcceleratorAntiMatterRecipeCategory extends AbstractRecipeCategory<PsuedoItem2ItemRecipe> {
    ...
    public static final ItemSlotObject MATTER_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 12, 2,
	    RecipeIngredientRole.INPUT);
    public static final ItemSlotObject CELL_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 12, 39,
	    RecipeIngredientRole.INPUT);
    public static final ItemSlotObject OUTPUT_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 101, 20,
	    RecipeIngredientRole.OUTPUT);

    public static final ArrowAnimatedObject ANIM_RIGHT_ARROW = new ArrowAnimatedObject(
	    NuclearJeiTextures.PARTICLEACCELERATOR_AMARROW_OFF, NuclearJeiTextures.PARTICLEACCELERATOR_AMARROW_ON, 17,
    ...
    // NuclearTextUtils.jeiTranslated("particalaccelerator.antimatter.collision"));
