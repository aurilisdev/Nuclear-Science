...
public class ParticleAcceleratorAntiMatterRecipeCategory extends AbstractRecipeCategory<PsuedoItem2ItemRecipe> {
    ...
    public static final ItemSlotObject MATTER_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 12, 2, true);
    public static final ItemSlotObject CELL_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 12, 39, true);
    public static final ItemSlotObject OUTPUT_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 101, 20, false);
