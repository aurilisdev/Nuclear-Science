...
public class NuclearSciencePsuedoRecipes {
	...
	GAS_CENTRIFUGE_RECIPES.add(new PsuedoGasCentrifugeRecipe(
		new GasIngredient(NuclearScienceTags.Gases.URANIUM_HEXAFLUORIDE, 5000, 350, 1),
		NUCLEAR_SCIENCE_ITEMS.get(0).get(2), NUCLEAR_SCIENCE_ITEMS.get(0).get(1),
		new ItemStack(NuclearScienceItems.ITEM_FISSILEDUST.get())));

	ANTI_MATTER_RECIPES.add(new PsuedoItem2ItemRecipe(Arrays.asList(NUCLEAR_SCIENCE_ITEMS.get(1).get(4)),
		NUCLEAR_SCIENCE_ITEMS.get(1).get(5)));

	DARK_MATTER_RECIPES.add(new PsuedoItem2ItemRecipe(Arrays.asList(NUCLEAR_SCIENCE_ITEMS.get(1).get(4)),
	...
	Item[] uraniumMisc = { NuclearScienceItems.ITEM_YELLOWCAKE.get(), NuclearScienceItems.ITEM_URANIUM238.get(),
		NuclearScienceItems.ITEM_URANIUM235.get() };

	NUCLEAR_SCIENCE_ITEMS.add(formItemStacks(uraniumMisc, 1));

	// Cells : 1
	Item[] cells = { NuclearScienceItems.ITEM_CELLEMPTY.get(), NuclearScienceItems.ITEM_CELLHEAVYWATER.get(),
		NuclearScienceItems.ITEM_CELLDEUTERIUM.get(), NuclearScienceItems.ITEM_CELLTRITIUM.get(),
		NuclearScienceItems.ITEM_CELLELECTROMAGNETIC.get(), NuclearScienceItems.ITEM_CELLANTIMATTERSMALL.get(),
		NuclearScienceItems.ITEM_CELLANTIMATTERLARGE.get(), NuclearScienceItems.ITEM_CELLDARKMATTER.get() };
