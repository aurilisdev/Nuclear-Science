...
public class UnifiedNuclearScienceRegister {
	...
	static {
		...
		// Misc
		BlockItemDescriptable.addDescription(() -> NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.steamfunnel), NuclearTextUtils.tooltip("steamfunneluse").withStyle(TextFormatting.DARK_GRAY));
	}
