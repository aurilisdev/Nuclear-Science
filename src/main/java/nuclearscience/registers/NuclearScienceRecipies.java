...
public class NuclearScienceRecipies {
	...
	public static final DeferredRegister<RecipeType<?>> RECIPE_TYPES = DeferredRegister.create(Registry.RECIPE_TYPE.key(), NuclearScience.ID);
	...
	// FLUIDITEM2GAS
	public static final RegistryObject<RecipeSerializer<?>> NUCLEAR_BOILER_SERIALIZER = RECIPE_SERIALIZER.register(NuclearBoilerRecipe.RECIPE_GROUP, () -> new FluidItem2FluidRecipeSerializer<>(NuclearBoilerRecipe::new));
