...
public class NuclearScienceRecipies {
    ...
    public static final DeferredRegister<RecipeSerializer<?>> RECIPE_SERIALIZER = DeferredRegister
	    .create(ForgeRegistries.RECIPE_SERIALIZERS, NuclearScience.ID);
    public static final DeferredRegister<RecipeType<?>> RECIPE_TYPES = DeferredRegister
	    .create(ForgeRegistries.RECIPE_TYPES, NuclearScience.ID);

    /* RECIPE TYPES */

    // ITEM2ITEM
    public static final RegistryObject<RecipeType<FissionReactorRecipe>> FISSION_REACTOR_TYPE = RECIPE_TYPES
	    .register(FissionReactorRecipe.RECIPE_GROUP, VoltaicRecipeType::new);
    public static final RegistryObject<RecipeType<FuelReprocessorRecipe>> FUEL_REPROCESSOR_TYPE = RECIPE_TYPES
	    .register(FuelReprocessorRecipe.RECIPE_GROUP, VoltaicRecipeType::new);

    // FLUIDITEM2GAS
    public static final RegistryObject<RecipeType<NuclearBoilerRecipe>> NUCLEAR_BOILER_TYPE = RECIPE_TYPES
	    .register(NuclearBoilerRecipe.RECIPE_GROUP, VoltaicRecipeType::new);

    // FLUIDITEM2ITEM
    public static final RegistryObject<RecipeType<ChemicalExtractorRecipe>> CHEMICAL_EXTRACTOR_TYPE = RECIPE_TYPES
	    .register(ChemicalExtractorRecipe.RECIPE_GROUP, VoltaicRecipeType::new);
    public static final RegistryObject<RecipeType<RadioactiveProcessorRecipe>> RADIOACTIVE_PROCESSOR_TYPE = RECIPE_TYPES
	    .register(RadioactiveProcessorRecipe.RECIPE_GROUP, VoltaicRecipeType::new);
    public static final RegistryObject<RecipeType<MSRFuelPreProcessorRecipe>> MSR_FUEL_PREPROCESSOR_TYPE = RECIPE_TYPES
	    .register(MSRFuelPreProcessorRecipe.RECIPE_GROUP, VoltaicRecipeType::new);

    /* RECIPE SERIALIZERS */

    // O2O
    public static final RegistryObject<RecipeSerializer<?>> FISSION_REACTOR_SERIALIZER = RECIPE_SERIALIZER.register(
	    FissionReactorRecipe.RECIPE_GROUP, () -> new Item2ItemRecipeSerializer<>(FissionReactorRecipe::new));
    public static final RegistryObject<RecipeSerializer<?>> FUEL_REPROCESSOR_SERIALIZER = RECIPE_SERIALIZER.register(
	    FuelReprocessorRecipe.RECIPE_GROUP, () -> new Item2ItemRecipeSerializer<>(FuelReprocessorRecipe::new));

    // FLUIDITEM2GAS
    public static final RegistryObject<RecipeSerializer<?>> NUCLEAR_BOILER_SERIALIZER = RECIPE_SERIALIZER.register(
	    NuclearBoilerRecipe.RECIPE_GROUP, () -> new FluidItem2GasRecipeSerializer<>(NuclearBoilerRecipe::new));

    // FLUIDITEM2ITEM
    public static final RegistryObject<RecipeSerializer<?>> CHEMICAL_EXTRACTOR_SERIALIZER = RECIPE_SERIALIZER.register(
	    ChemicalExtractorRecipe.RECIPE_GROUP,
