...
public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, NuclearScience.ID);
	...
	public static final RegistryObject<Item> ITEM_HAZMATHELMET = ITEMS.register("hazmathelmet", () -> new ItemHazmatArmor(ArmorMaterialHazmat.hazmat, EquipmentSlotType.HEAD, new Item.Properties().durability(26000), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_HAZMATPLATE = ITEMS.register("hazmatplate", () -> new ItemHazmatArmor(ArmorMaterialHazmat.hazmat, EquipmentSlotType.CHEST, new Item.Properties().durability(26000), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_HAZMATLEGS = ITEMS.register("hazmatlegs", () -> new ItemHazmatArmor(ArmorMaterialHazmat.hazmat, EquipmentSlotType.LEGS, new Item.Properties().durability(26000), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_HAZMATBOOTS = ITEMS.register("hazmatboots", () -> new ItemHazmatArmor(ArmorMaterialHazmat.hazmat, EquipmentSlotType.FEET, new Item.Properties().durability(26000), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_REINFORCEDHAZMATHELMET = ITEMS.register("reinforcedhazmathelmet", () -> new ItemHazmatArmor(ArmorMaterialHazmat.reinforcedhazmat, EquipmentSlotType.HEAD, new Item.Properties().stacksTo(1).durability(26000 * 5), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_REINFORCEDHAZMATPLATE = ITEMS.register("reinforcedhazmatplate", () -> new ItemHazmatArmor(ArmorMaterialHazmat.reinforcedhazmat, EquipmentSlotType.CHEST, new Item.Properties().stacksTo(1).durability(26000 * 5), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_REINFORCEDHAZMATLEGS = ITEMS.register("reinforcedhazmatlegs", () -> new ItemHazmatArmor(ArmorMaterialHazmat.reinforcedhazmat, EquipmentSlotType.LEGS, new Item.Properties().stacksTo(1).durability(26000 * 5), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_REINFORCEDHAZMATBOOTS = ITEMS.register("reinforcedhazmatboots", () -> new ItemHazmatArmor(ArmorMaterialHazmat.reinforcedhazmat, EquipmentSlotType.FEET, new Item.Properties().stacksTo(1).durability(26000 * 5), () -> NuclearScienceCreativeTabs.MAIN));
