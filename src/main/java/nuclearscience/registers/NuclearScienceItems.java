...
public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, NuclearScience.ID);
	...
	public static final RegistryObject<Item> ITEM_CELLDARKMATTER = ITEMS.register("celldarkmatter", () -> new ItemAntimatter(new Item.Properties().durability(12), () -> NuclearScienceCreativeTabs.MAIN));
	...
	public static final RegistryObject<Item> ITEM_HAZMATHELMET = ITEMS.register("hazmathelmet", () -> new ItemHazmatArmor(ArmorMaterialHazmat.hazmat, EquipmentSlot.HEAD, new Item.Properties().durability(26000), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_HAZMATPLATE = ITEMS.register("hazmatplate", () -> new ItemHazmatArmor(ArmorMaterialHazmat.hazmat, EquipmentSlot.CHEST, new Item.Properties().durability(26000), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_HAZMATLEGS = ITEMS.register("hazmatlegs", () -> new ItemHazmatArmor(ArmorMaterialHazmat.hazmat, EquipmentSlot.LEGS, new Item.Properties().durability(26000), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_HAZMATBOOTS = ITEMS.register("hazmatboots", () -> new ItemHazmatArmor(ArmorMaterialHazmat.hazmat, EquipmentSlot.FEET, new Item.Properties().durability(26000), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_REINFORCEDHAZMATHELMET = ITEMS.register("reinforcedhazmathelmet", () -> new ItemHazmatArmor(ArmorMaterialHazmat.reinforcedhazmat, EquipmentSlot.HEAD, new Item.Properties().stacksTo(1).durability(26000 * 5), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_REINFORCEDHAZMATPLATE = ITEMS.register("reinforcedhazmatplate", () -> new ItemHazmatArmor(ArmorMaterialHazmat.reinforcedhazmat, EquipmentSlot.CHEST, new Item.Properties().stacksTo(1).durability(26000 * 5), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_REINFORCEDHAZMATLEGS = ITEMS.register("reinforcedhazmatlegs", () -> new ItemHazmatArmor(ArmorMaterialHazmat.reinforcedhazmat, EquipmentSlot.LEGS, new Item.Properties().stacksTo(1).durability(26000 * 5), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_REINFORCEDHAZMATBOOTS = ITEMS.register("reinforcedhazmatboots", () -> new ItemHazmatArmor(ArmorMaterialHazmat.reinforcedhazmat, EquipmentSlot.FEET, new Item.Properties().stacksTo(1).durability(26000 * 5), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
