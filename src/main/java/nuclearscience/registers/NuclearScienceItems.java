...
public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, NuclearScience.ID);
	...
	public static final RegistryObject<Item> ITEM_URANIUM235 = ITEMS.register("uranium235", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_URANIUM238 = ITEMS.register("uranium238", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_PLUTONIUM239 = ITEMS.register("plutonium239", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_POLONIUM210 = ITEMS.register("polonium210", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_ACTINIUM225 = ITEMS.register("actinium225", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_LIFHT4PUF3 = ITEMS.register("lifthf4uf4", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_FLINAK = ITEMS.register("flinak", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_YELLOWCAKE = ITEMS.register("yellowcake", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_FISSILEDUST = ITEMS.register("fissiledust", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_FISSILE_SALT = ITEMS.register("fissilesalt", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_PLUTONIUMOXIDE = ITEMS.register("plutoniumoxide", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_POLONIUM210_CHUNK = ITEMS.register("polonium210chunk", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_THORIANITEDUST = ITEMS.register("thorianitedust", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_ACTINIUMOXIDE = ITEMS.register("actiniumoxide", () -> new ItemVoltaic(new Item.Properties(), () -> NuclearScienceCreativeTabs.MAIN));

	public static final RegistryObject<Item> ITEM_FUELLEUO2 = ITEMS.register("fuelleuo2", () -> new ItemVoltaic(new Item.Properties().stacksTo(1).durability(26000), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_FUELHEUO2 = ITEMS.register("fuelheuo2", () -> new ItemVoltaic(new Item.Properties().stacksTo(1).durability(24000), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_FUELPLUTONIUM = ITEMS.register("fuelplutonium", () -> new ItemVoltaic(new Item.Properties().stacksTo(1).durability(120000), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_FUELSPENT = ITEMS.register("fuelspent", () -> new ItemVoltaic(new Item.Properties().stacksTo(1), () -> NuclearScienceCreativeTabs.MAIN));
	...
	public static final RegistryObject<Item> ITEM_GEIGERCOUNTER = ITEMS.register("geigercounter", () -> new ItemGeigerCounter((ElectricItemProperties) new ElectricItemProperties().capacity(1666666.66667).extract(TransferPack.joulesVoltage(694.4444444458333, 120.0)).receive(TransferPack.joulesVoltage(694.4444444458333, 120.0)).setIsEnergyStorageOnly().stacksTo(1), () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_HAZMATHELMET = ITEMS.register("hazmathelmet", () -> new ItemHazmatArmor(ArmorMaterialHazmat.hazmat, EquipmentSlotType.HEAD, new Item.Properties().durability(26000), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_HAZMATPLATE = ITEMS.register("hazmatplate", () -> new ItemHazmatArmor(ArmorMaterialHazmat.hazmat, EquipmentSlotType.CHEST, new Item.Properties().durability(26000), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_HAZMATLEGS = ITEMS.register("hazmatlegs", () -> new ItemHazmatArmor(ArmorMaterialHazmat.hazmat, EquipmentSlotType.LEGS, new Item.Properties().durability(26000), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_HAZMATBOOTS = ITEMS.register("hazmatboots", () -> new ItemHazmatArmor(ArmorMaterialHazmat.hazmat, EquipmentSlotType.FEET, new Item.Properties().durability(26000), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_REINFORCEDHAZMATHELMET = ITEMS.register("reinforcedhazmathelmet", () -> new ItemHazmatArmor(ArmorMaterialHazmat.reinforcedhazmat, EquipmentSlotType.HEAD, new Item.Properties().stacksTo(1).durability(26000 * 5), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_REINFORCEDHAZMATPLATE = ITEMS.register("reinforcedhazmatplate", () -> new ItemHazmatArmor(ArmorMaterialHazmat.reinforcedhazmat, EquipmentSlotType.CHEST, new Item.Properties().stacksTo(1).durability(26000 * 5), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_REINFORCEDHAZMATLEGS = ITEMS.register("reinforcedhazmatlegs", () -> new ItemHazmatArmor(ArmorMaterialHazmat.reinforcedhazmat, EquipmentSlotType.LEGS, new Item.Properties().stacksTo(1).durability(26000 * 5), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
	public static final RegistryObject<Item> ITEM_REINFORCEDHAZMATBOOTS = ITEMS.register("reinforcedhazmatboots", () -> new ItemHazmatArmor(ArmorMaterialHazmat.reinforcedhazmat, EquipmentSlotType.FEET, new Item.Properties().stacksTo(1).durability(26000 * 5), 1000, 1, () -> NuclearScienceCreativeTabs.MAIN));
