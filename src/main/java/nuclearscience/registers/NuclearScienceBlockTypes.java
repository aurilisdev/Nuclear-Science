...
public class NuclearScienceBlockTypes {
	...
	public static final RegistryObject<BlockEntityType<TileReactorCore>> TILE_REACTORCORE = BLOCK_ENTITY_TYPES.register("reactorcore", () -> new BlockEntityType<>(TileReactorCore::new, Sets.newHashSet(blockReactorCore), null));
	...
	public static final RegistryObject<BlockEntityType<TileMSRReactorCore>> TILE_MSRREACTORCORE = BLOCK_ENTITY_TYPES.register("msrreactorcore", () -> new BlockEntityType<>(TileMSRReactorCore::new, Sets.newHashSet(blockMsrReactorCore), null));
