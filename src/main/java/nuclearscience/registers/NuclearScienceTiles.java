...
public class NuclearScienceTiles {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileGasCentrifuge>> TILE_GASCENTRIFUGE = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.gascentrifuge.tag(),
		    () -> new BlockEntityType<>(TileGasCentrifuge::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileNuclearBoiler>> TILE_CHEMICALBOILER = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.nuclearboiler.tag(),
		    () -> new BlockEntityType<>(TileNuclearBoiler::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileChemicalExtractor>> TILE_CHEMICALEXTRACTOR = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.chemicalextractor.tag(),
		    () -> new BlockEntityType<>(TileChemicalExtractor::new,
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileRadioisotopeGenerator>> TILE_RADIOISOTOPEGENERATOR = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.radioisotopegenerator.tag(),
		    () -> new BlockEntityType<>(TileRadioisotopeGenerator::new,
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileMoltenSaltSupplier>> TILE_MOLTENSALTSUPPLIER = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.moltensaltsupplier.tag(),
		    () -> new BlockEntityType<>(TileMoltenSaltSupplier::new,
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileFreezePlug>> TILE_FREEZEPLUG = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.freezeplug.tag(),
		    () -> new BlockEntityType<>(TileFreezePlug::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileTurbine>> TILE_TURBINE = BLOCK_ENTITY_TYPES
	    .register("turbine", () -> new BlockEntityType<>(TileTurbine::new,
		    Sets.newHashSet(NuclearScienceBlocks.BLOCK_TURBINE.get()), null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileFissionReactorCore>> TILE_REACTORCORE = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.fissionreactorcore.tag(),
		    () -> new BlockEntityType<>(TileFissionReactorCore::new,
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileFusionReactorCore>> TILE_FUSIONREACTORCORE = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.fusionreactorcore.tag(),
		    () -> new BlockEntityType<>(TileFusionReactorCore::new,
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileParticleInjector>> TILE_PARTICLEINJECTOR = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.particleinjector.tag(),
		    () -> new BlockEntityType<>(TileParticleInjector::new,
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileElectromagneticGateway>> TILE_ELECTROMAGNETICGATEWAY = BLOCK_ENTITY_TYPES
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TilePlasma>> TILE_PLASMA = BLOCK_ENTITY_TYPES
	    .register("plasma", () -> new BlockEntityType<>(TilePlasma::new,
		    Sets.newHashSet(NuclearScienceBlocks.BLOCK_PLASMA.get()), null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileMeltedReactor>> TILE_MELTEDREACTOR = BLOCK_ENTITY_TYPES
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileQuantumTunnel>> TILE_QUANTUMCAPACITOR = BLOCK_ENTITY_TYPES
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileFuelReprocessor>> TILE_FUELREPROCESSOR = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.fuelreprocessor.tag(),
		    () -> new BlockEntityType<>(TileFuelReprocessor::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileRadioactiveProcessor>> TILE_RADIOACTIVEPROCESSOR = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.radioactiveprocessor.tag(),
		    () -> new BlockEntityType<>(TileRadioactiveProcessor::new,
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileMSRFuelPreProcessor>> TILE_MSRFUELPREPROCESSOR = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.msrfuelpreprocessor.tag(),
		    () -> new BlockEntityType<>(TileMSRFuelPreProcessor::new,
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileMSReactorCore>> TILE_MSRREACTORCORE = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.msreactorcore.tag(),
		    () -> new BlockEntityType<>(TileMSReactorCore::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileHeatExchanger>> TILE_HEATEXCHANGER = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.heatexchanger.tag(),
		    () -> new BlockEntityType<>(TileHeatExchanger::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileTeleporter>> TILE_TELEPORTER = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.teleporter.tag(),
		    () -> new BlockEntityType<>(TileTeleporter::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileControlRod.TileFissionControlRod>> TILE_FISSIONCONTROLROD = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.fissioncontrolrod.tag(),
		    () -> new BlockEntityType<>(TileControlRod.TileFissionControlRod::new,
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileControlRod.TileMSControlRod>> TILE_MSCONTROLROD = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.mscontrolrod.tag(),
		    () -> new BlockEntityType<>(TileControlRod.TileMSControlRod::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileMoltenSaltPipe>> TILE_MOLTENSALTPIPE = BLOCK_ENTITY_TYPES
	    .register("moltensaltpipegenerictile",
		    () -> new BlockEntityType<>(TileMoltenSaltPipe::new, BlockMoltenSaltPipe.PIPESET, null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileSiren>> TILE_SIREN = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.siren.tag(),
		    () -> new BlockEntityType<>(TileSiren::new,
			    Sets.newHashSet(
				    NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.siren)),
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileAtomicAssembler>> TILE_ATOMICASSEMBLER = BLOCK_ENTITY_TYPES
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileChunkloader>> TILE_CHUNKLOADER = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.chunkloader.tag(),
		    () -> new BlockEntityType<>(TileChunkloader::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileCloudChamber>> TILE_CLOUDCHAMBER = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.cloudchamber.tag(),
		    () -> new BlockEntityType<>(TileCloudChamber::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileSteamFunnel>> TILE_STEAMFUNNEL = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.steamfunnel.tag(),
		    () -> new BlockEntityType<>(TileSteamFunnel::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileFalloutScrubber>> TILE_FALLOUTSCRUBBER = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.falloutscrubber.tag(),
		    () -> new BlockEntityType<>(TileFalloutScrubber::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileReactorLogisticsCable>> TILE_REACTORLOGISTICSCABLE = BLOCK_ENTITY_TYPES
	    .register("reactorlogisticscable", () -> new BlockEntityType<>(TileReactorLogisticsCable::new,
		    BlockReactorLogisticsCable.PIPESET, null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileController>> TILE_LOGISTICSCONTROLLER = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.logisticscontroller.tag(),
		    () -> new BlockEntityType<>(TileController::new,
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileFissionInterface>> TILE_FISSIONINTERFACE = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.fissioninterface.tag(),
		    () -> new BlockEntityType<>(TileFissionInterface::new,
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileMSInterface>> TILE_MSINTERFACE = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.msinterface.tag(),
		    () -> new BlockEntityType<>(TileMSInterface::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileFusionInterface>> TILE_FUSIONINTERFACE = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.fusioninterface.tag(),
		    () -> new BlockEntityType<>(TileFusionInterface::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileControlRodModule>> TILE_CONTROLRODMODULE = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.controlrodmodule.tag(),
		    () -> new BlockEntityType<>(TileControlRodModule::new,
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileSupplyModule>> TILE_SUPPLYMODULE = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.supplymodule.tag(),
		    () -> new BlockEntityType<>(TileSupplyModule::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileMonitorModule>> TILE_MONITORMODULE = BLOCK_ENTITY_TYPES
	    .register(SubtypeNuclearMachine.monitormodule.tag(),
		    () -> new BlockEntityType<>(TileMonitorModule::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileThermometerModule>> TILE_THERMOMETERMODULE = BLOCK_ENTITY_TYPES
