...
public class DeferredRegisters {
	...
	BLOCKS.register("radioisotopegenerator",
		supplier(blockRadioisotopeGenerator = new BlockRadioisotopeGenerator()));
	...
	BLOCKS.register("electromagneticbooster",
		supplier(blockElectromagneticBooster = new BlockElectromagneticBooster()));
	BLOCKS.register("electromagneticswitch",
		supplier(blockElectromagneticSwitch = new BlockElectromagneticSwitch()));
	...
	BLOCKS.register("blocklead",
		supplier(blocklead = new Block(Properties.create(Material.IRON, MaterialColor.BLACK)
	...
	for (SubtypeMoltenSaltPipe subtype : SubtypeMoltenSaltPipe.values()) {
	    SUBTYPEBLOCKREGISTER_MAPPINGS.put(subtype,
		    BLOCKS.register(subtype.tag(), supplier(new BlockMoltenSaltPipe(subtype), subtype)));
	}
	...
	ITEMS.register("nuclearboiler", supplier(
		new BlockItemDescriptable(blockNuclearBoiler, new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("chemicalextractor", supplier(
		new BlockItemDescriptable(blockChemicalExtractor, new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("radioisotopegenerator", supplier(new BlockItemDescriptable(blockRadioisotopeGenerator,
		new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("freezeplug", supplier(
		new BlockItemDescriptable(blockFreezePlug, new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("turbine",
		supplier(new BlockItemDescriptable(blockTurbine, new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("reactorcore", supplier(
		new BlockItemDescriptable(blockReactorCore, new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("fuelreprocessor", supplier(
		new BlockItemDescriptable(blockFuelReprocessor, new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("radioactiveprocessor", supplier(new BlockItemDescriptable(blockRadioactiveProcessor,
		new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("msrfuelpreprocessor", supplier(new BlockItemDescriptable(blockMSRFuelPreProcessor,
		new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("blocklead", supplier(
		new BlockItemDescriptable(blocklead, new BlockItem.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("electromagnet", supplier(
		new BlockItemDescriptable(blockElectromagnet, new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("electromagneticglass", supplier(new BlockItemDescriptable(blockElectromagneticGlass,
		new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("electromagneticbooster", supplier(new BlockItemDescriptable(blockElectromagneticBooster,
		new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("electromagneticswitch", supplier(new BlockItemDescriptable(blockElectromagneticSwitch,
		new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("fusionreactorcore", supplier(
		new BlockItemDescriptable(blockFusionReactorCore, new Item.Properties().group(References.NUCLEARTAB))));
	...
	ITEMS.register("teleporter", supplier(
		new BlockItemDescriptable(blockTeleporter, new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("controlrodassembly", supplier(new BlockItemDescriptable(blockControlRodAssembly,
		new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("msrreactorcore", supplier(
		new BlockItemDescriptable(blockMsrReactorCore, new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("heatexchanger", supplier(
		new BlockItemDescriptable(blockHeatExchanger, new Item.Properties().group(References.NUCLEARTAB))));
	ITEMS.register("moltensaltsupplier", supplier(new BlockItemDescriptable(blockMoltenSaltSupplier,
		new Item.Properties().group(References.NUCLEARTAB))));
	for (SubtypeMoltenSaltPipe subtype : SubtypeMoltenSaltPipe.values()) {
	    ITEMS.register(subtype.tag(), supplier(new BlockItemDescriptable(SUBTYPEBLOCK_MAPPINGS.get(subtype),
		    new Item.Properties().group(References.NUCLEARTAB)), subtype));
	}
	ITEMS.register("radioactivegrass", supplier(
		new BlockItemDescriptable(blockRadioactiveGrass, new Item.Properties().group(References.NUCLEARTAB))));
	...
	BlockItemDescriptable.addDescription(blockRadioactiveProcessor,
		"|translate|tooltip.radioactiveprocessor.voltage");
    ...
    public static final RegistryObject<Item> ITEM_CELLDARKMATTER = ITEMS.register("celldarkmatter",
	    supplier(new Item(new Item.Properties().group(References.NUCLEARTAB))));
    public static final RegistryObject<Item> ITEM_FUELHEUO2 = ITEMS.register("fuelheuo2", supplier(new ItemRadioactive(
	    new Item.Properties().group(References.NUCLEARTAB).maxStackSize(1).defaultMaxDamage(24000))));
    public static final RegistryObject<Item> ITEM_FUELLEUO2 = ITEMS.register("fuelleuo2", supplier(new ItemRadioactive(
    ...
    public static final RegistryObject<TileEntityType<TileGasCentrifuge>> TILE_GASCENTRIFUGE = TILES.register(
	    "gascentrifuge",
	    () -> new TileEntityType<>(TileGasCentrifuge::new, Sets.newHashSet(blockGasCentrifuge), null));
    public static final RegistryObject<TileEntityType<TileNuclearBoiler>> TILE_CHEMICALBOILER = TILES.register(
	    "nuclearboiler",
	    () -> new TileEntityType<>(TileNuclearBoiler::new, Sets.newHashSet(blockNuclearBoiler), null));
    public static final RegistryObject<TileEntityType<TileChemicalExtractor>> TILE_CHEMICALEXTRACTOR = TILES.register(
	    "chemicalextractor",
	    () -> new TileEntityType<>(TileChemicalExtractor::new, Sets.newHashSet(blockChemicalExtractor), null));
    public static final RegistryObject<TileEntityType<TileRadioisotopeGenerator>> TILE_RADIOISOTOPEGENERATOR = TILES
	    .register("radioisotopegenerator", () -> new TileEntityType<>(TileRadioisotopeGenerator::new,
		    Sets.newHashSet(blockRadioisotopeGenerator), null));
    public static final RegistryObject<TileEntityType<TileMoltenSaltSupplier>> TILE_MOLTENSALTSUPPLIER = TILES.register(
	    "moltensaltsupplier",
	    () -> new TileEntityType<>(TileMoltenSaltSupplier::new, Sets.newHashSet(blockMoltenSaltSupplier), null));
    ...
    public static final RegistryObject<TileEntityType<TileFusionReactorCore>> TILE_FUSIONREACTORCORE = TILES.register(
	    "fusionreactorcore",
	    () -> new TileEntityType<>(TileFusionReactorCore::new, Sets.newHashSet(blockFusionReactorCore), null));
    public static final RegistryObject<TileEntityType<TileParticleInjector>> TILE_PARTICLEINJECTOR = TILES.register(
	    "particleinjector",
	    () -> new TileEntityType<>(TileParticleInjector::new, Sets.newHashSet(blockParticleInjector), null));
    public static final RegistryObject<TileEntityType<TileElectromagneticSwitch>> TILE_ELECTROMAGNETICSWITCH = TILES
	    .register("electromagneticswitch", () -> new TileEntityType<>(TileElectromagneticSwitch::new,
    ...
    public static final RegistryObject<TileEntityType<TileFuelReprocessor>> TILE_FUELREPROCESSOR = TILES.register(
	    "fuelreprocessor",
	    () -> new TileEntityType<>(TileFuelReprocessor::new, Sets.newHashSet(blockFuelReprocessor), null));
    public static final RegistryObject<TileEntityType<TileRadioactiveProcessor>> TILE_RADIOACTIVEPROCESSOR = TILES
	    .register("radioactiveprocessor", () -> new TileEntityType<>(TileRadioactiveProcessor::new,
		    Sets.newHashSet(blockRadioactiveProcessor), null));
    public static final RegistryObject<TileEntityType<TileMSRFuelPreProcessor>> TILE_MSRFUELPREPROCESSOR = TILES
	    .register("msrfuelpreprocessor", () -> new TileEntityType<>(TileMSRFuelPreProcessor::new,
		    Sets.newHashSet(blockMSRFuelPreProcessor), null));
    public static final RegistryObject<TileEntityType<TileMSRReactorCore>> TILE_MSRREACTORCORE = TILES.register(
	    "msrreactorcore",
	    () -> new TileEntityType<>(TileMSRReactorCore::new, Sets.newHashSet(blockMsrReactorCore), null));
    public static final RegistryObject<TileEntityType<TileHeatExchanger>> TILE_HEATEXCHANGER = TILES.register(
	    "heatexchanger",
    ...
    public static final RegistryObject<TileEntityType<TileControlRodAssembly>> TILE_CONTROLRODASSEMBLY = TILES.register(
	    "controlrodassembly",
	    () -> new TileEntityType<>(TileControlRodAssembly::new, Sets.newHashSet(blockControlRodAssembly), null));

    public static final RegistryObject<TileEntityType<TileMoltenSaltPipe>> TILE_MOLTENSALTPIPE = TILES.register(
    ...
    public static final RegistryObject<ContainerType<ContainerNuclearBoiler>> CONTAINER_NUCLEARBOILER = CONTAINERS
	    .register("nuclearboiler", () -> new ContainerType<>(ContainerNuclearBoiler::new));
    ...
    public static final RegistryObject<ContainerType<ContainerFreezePlug>> CONTAINER_FREEZEPLUG = CONTAINERS
	    .register("freezeplug", () -> new ContainerType<>(ContainerFreezePlug::new));
    public static final RegistryObject<ContainerType<ContainerReactorCore>> CONTAINER_REACTORCORE = CONTAINERS
    ...
    public static final RegistryObject<ContainerType<ContainerMSRReactorCore>> CONTAINER_MSRREACTORCORE = CONTAINERS
	    .register("msrreactorcore", () -> new ContainerType<>(ContainerMSRReactorCore::new));
    public static final RegistryObject<ContainerType<ContainerMoltenSaltSupplier>> CONTAINER_MOLTENSALTSUPPLIER = CONTAINERS
	    .register("moltensaltsupplier", () -> new ContainerType<>(ContainerMoltenSaltSupplier::new));
