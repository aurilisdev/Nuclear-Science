...
public class ParticleOptionSmoke extends ParticleType<ParticleOptionSmoke> implements ParticleOptions {
    ...
    public static final MapCodec<ParticleOptionSmoke> CODEC = RecordCodecBuilder.mapCodec(instance -> instance
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ParticleOptionSmoke> STREAM_CODEC = CodecUtils.composite(
	    ByteBufCodecs.FLOAT, instance0 -> instance0.r, ByteBufCodecs.FLOAT, instance0 -> instance0.g,
	    ByteBufCodecs.FLOAT, instance0 -> instance0.b, ByteBufCodecs.FLOAT, instance0 -> instance0.scale,
	    ByteBufCodecs.FLOAT, instance0 -> instance0.gravity, ByteBufCodecs.INT, instance0 -> instance0.lifetime,
	    ByteBufCodecs.BOOL, instance0 -> instance0.hasPhysics, (r, g, b, scale, gravity, lifetime,
		    physics) -> new ParticleOptionSmoke().setParameters(r, g, b, scale, gravity, lifetime, physics));
