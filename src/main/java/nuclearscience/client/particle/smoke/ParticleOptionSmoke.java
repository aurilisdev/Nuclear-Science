...
public class ParticleOptionSmoke extends ParticleType<ParticleOptionSmoke> implements IParticleData {
    ...
    public static final StreamCodec<PacketBuffer, ParticleOptionSmoke> STREAM_CODEC = new StreamCodec<PacketBuffer, ParticleOptionSmoke>() {
		
		@Override
		public void encode(PacketBuffer buffer, ParticleOptionSmoke particle) {
		...
		@Override
		public ParticleOptionSmoke decode(PacketBuffer buffer) {
			return new ParticleOptionSmoke().setParameters(StreamCodec.FLOAT.decode(buffer), StreamCodec.FLOAT.decode(buffer), StreamCodec.FLOAT.decode(buffer), StreamCodec.FLOAT.decode(buffer), StreamCodec.FLOAT.decode(buffer), StreamCodec.INT.decode(buffer), StreamCodec.BOOL.decode(buffer));
		}
	};
	
	public static final IParticleData.IDeserializer<ParticleOptionSmoke> DESERIALIZER = new IParticleData.IDeserializer<ParticleOptionSmoke>() {
		...
		@Override
		public ParticleOptionSmoke fromNetwork(ParticleType<ParticleOptionSmoke> pParticleType, PacketBuffer pBuffer) {
	...
	public String writeToString() {
		return ForgeRegistries.PARTICLE_TYPES.getKey(getType()).toString() + ", r: " + r + ", g: " + g + ", b: " + b + ", scale: " + scale + ", gravity: " + gravity + ", lifetime: " + lifetime + ", physics: " + hasPhysics;
	}
