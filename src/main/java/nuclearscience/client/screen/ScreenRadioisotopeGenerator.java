...
public class ScreenRadioisotopeGenerator extends GenericScreen<ContainerRadioisotopeGenerator> {
	...
	addComponent(new ScreenComponentProgress(ScreenComponentProgress.ProgressBars.COUNTDOWN_FLAME, () -> {
	    ...
	    double currentOutput = in.getCount() * NuclearConstants.RADIOISOTOPEGENERATOR_OUTPUT_MULTIPLIER
		    * rad.amount();
	    if (currentOutput > 0) {
		return 1;
	    }
	...
	addComponent(new ScreenComponentMultiLabel(0, 0, graphics -> {
	    ...
	    TransferPack transfer = TransferPack.ampsVoltage(
		    currentOutput / NuclearConstants.RADIOISOTOPEGENERATOR_VOLTAGE,
	...
	TransferPack transfer = TransferPack.ampsVoltage(currentOutput / NuclearConstants.RADIOISOTOPEGENERATOR_VOLTAGE,
		NuclearConstants.RADIOISOTOPEGENERATOR_VOLTAGE);
