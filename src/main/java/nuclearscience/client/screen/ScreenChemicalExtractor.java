...
@OnlyIn(Dist.CLIENT)
public class ScreenChemicalExtractor extends GenericContainerScreenUpgradeable<ContainerChemicalExtractor> implements IHasContainer<ContainerChemicalExtractor> {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int mouseX, int mouseY) {
		...
		font.func_243248_b(matrixStack, new TranslationTextComponent("gui.chemicalextractor.usage", ElectricityChatFormatter.getDisplayShort(container.getJoulesPerTick() * 20, ElectricUnit.WATT)), playerInventoryTitleX,
				playerInventoryTitleY, 4210752);
		font.func_243248_b(matrixStack, new TranslationTextComponent("gui.chemicalextractor.voltage", ElectricityChatFormatter.getDisplayShort(container.getVoltage(), ElectricUnit.VOLTAGE)),
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack stack, float partialTicks, int mouseX, int mouseY) {
		...
		blit(stack, guiLeft + 51, guiTop + 68 - container.getWaterLevelScaled(), 214 + 18, 31, 16, container.getWaterLevelScaled());
	}
