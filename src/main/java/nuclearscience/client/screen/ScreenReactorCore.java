...
public class ScreenReactorCore extends GenericContainerScreen<ContainerReactorCore> implements IHasContainer<ContainerReactorCore> {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int mouseX, int mouseY) {
		...
		font.func_243248_b(matrixStack, new TranslationTextComponent("gui.reactorcore.temperature", (int) container.getTemperature() / 4 + 15 + "°C"), titleX, (float) titleY + 14 * 3, 4210752);
