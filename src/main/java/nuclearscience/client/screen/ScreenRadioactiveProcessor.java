...
public class ScreenRadioactiveProcessor extends GenericScreen<ContainerRadioactiveProcessor> {
    ...
    public ScreenRadioactiveProcessor(ContainerRadioactiveProcessor container, PlayerInventory playerInventory, ITextComponent title) {
	...
	if (box != null) {
	    ...
	    list.add(new TranslationTextComponent("gui.radioactiveprocessor.usage",
	    ...
	    list.add(new TranslationTextComponent("gui.radioactiveprocessor.voltage",
