...
public abstract class GenericInterfaceBoundScreen<T extends GenericInterfaceBoundContainer<?>>
	...
	binderWrapper = new WrapperBindInterface(this, 0, 0, -AbstractScreenComponentInfo.SIZE + 1, 2, needsButton,
		updateSlots);
	addComponent(binderSlider = new ScreenComponentVerticalSlider(153, 57, 100)
		.setClickConsumer(binderWrapper.getSliderClickedConsumer())
		.setDragConsumer(binderWrapper.getSliderDraggedConsumer()));
	if (needsButton) {
