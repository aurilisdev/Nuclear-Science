...
public class NuclearScienceClientRegister {
	...
	public static void setup() {
		...
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.atomicassembler), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.chemicalextractor), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.cloudchamber), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.fissioninterface), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.fissionreactorcore), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.fissioninterface), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.fusioninterface), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.logisticscontroller), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.msinterface), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.nuclearboiler), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.radioactiveprocessor), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.supplymodule), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.thermometermodule), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCK_ELECTORMAGNETICBOOSTER.get(), RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCK_ELECTROMAGNETICDIODE.get(), NuclearScienceClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_ELECTROMAGENT.getValue(SubtypeElectromagent.electromagneticglass), RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCK_PLASMA.get(), RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_RADIATION_SHIELDING.getValue(SubtypeRadiationShielding.glass), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_RADIATION_SHIELDING.getValue(SubtypeRadiationShielding.door), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(NuclearScienceBlocks.BLOCKS_RADIATION_SHIELDING.getValue(SubtypeRadiationShielding.trapdoor), RenderType.cutout());
