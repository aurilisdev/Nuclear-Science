...
public class NuclearScienceClientRegister {
	...
	MenuScreens.register(NuclearScienceMenuTypes.CONTAINER_RADIOISOTOPEGENERATOR.get(),
	...
	MenuScreens.register(NuclearScienceMenuTypes.CONTAINER_MSRFUELPREPROCESSOR.get(),
		ScreenMSRFuelPreProcessor::new);
	MenuScreens.register(NuclearScienceMenuTypes.CONTAINER_RADIOACTIVEPROCESSOR.get(),
		ScreenRadioactiveProcessor::new);
	...
	MenuScreens.register(NuclearScienceMenuTypes.CONTAINER_ELECTROMAGNETICGATEWAY.get(),
