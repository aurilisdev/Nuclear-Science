...
public class ChapterFusionReactor extends Chapter {
	...
	private static final ItemWrapperObject LOGO = new ItemWrapperObject(7, 10, 2.0F, 32, 32, NuclearScienceBlocks.blockFusionReactorCore.asItem());
	...
	@Override
	public void addData() {
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.fusionreactor.l1")).setIndentions(1));
		...
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.fusionreactor.l2")).setIndentions(1).setSeparateStart());
		...
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.fusionreactor.l3")).setIndentions(1).setSeparateStart());
		...
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.fusionreactor.l4")).setIndentions(1).setSeparateStart());
		...
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.fusionreactor.l5")).setIndentions(1).setSeparateStart());
		...
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.fusionreactor.l6")).setIndentions(1).setSeparateStart());
