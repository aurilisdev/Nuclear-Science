...
public class ChapterParticleAccelerator extends Chapter {
	...
	protected List<Page> genPages() {
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.particleaccelerator.p1l1"), 
			//
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.particleaccelerator.p2l1"), 
			//
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.particleaccelerator.p4l1"), 
			//
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.particleaccelerator.p5l1"), 
			//
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.particleaccelerator.p7l1"), 
			//
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.particleaccelerator.p9l1"), 
			//
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.particleaccelerator.p11l1"), 
			//
