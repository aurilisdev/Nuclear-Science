...
public class ChapterFissionReactor extends Chapter {
	...
	protected List<Page> genPages() {
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.fissionreactor.p1l1"), 
			//
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.fissionreactor.p3l1"), 
			//
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.fissionreactor.p5l1"), 
			//
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.fissionreactor.p6l1"), 
			//
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.fissionreactor.p7l1"), 
			//
