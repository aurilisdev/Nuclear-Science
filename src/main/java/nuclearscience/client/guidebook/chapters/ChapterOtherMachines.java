...
public class ChapterOtherMachines extends Chapter {
	...
	protected List<Page> genPages() {
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.othermachines.p3l1"), 
			//
		...
		pages.add(new Page(new TextWrapperObject[] { 
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.othermachines.p7l1"), 
			//
		...
		pages.add(new Page(new ImageWrapperObject[] { 
			...
			new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.othermachines.p9l1"), 
			//
