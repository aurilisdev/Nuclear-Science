...
public class ChapterOtherMachines extends Chapter {
	...
	public void addData() {
		...
		// Teleporter
		pageData.add(new TextWrapperObject(NuclearScienceItems.ITEMS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.teleporter).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered());
		...
		pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook("chapter.othermachines.teleporter2", NuclearScienceItems.ITEM_FREQUENCYCARD.get().getDescription().copy().withStyle(TextFormatting.BOLD))).setSeparateStart());
		...
		// Chunkloader
		pageData.add(new TextWrapperObject(NuclearScienceItems.ITEMS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.chunkloader).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
		...
		// Atomic Assembler
		pageData.add(new TextWrapperObject(NuclearScienceItems.ITEMS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.atomicassembler).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
