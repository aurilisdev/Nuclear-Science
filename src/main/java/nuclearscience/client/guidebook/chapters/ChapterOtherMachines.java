...
public class ChapterOtherMachines extends Chapter {
	...
	public void addData() {
		...
		pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook("chapter.othermachines.teleporter1", ChatFormatter.getChatDisplayShort(NuclearConfig.INSTANCE.TELEPORTER_USAGE_PER_TELEPORT.get(), DisplayUnits.JOULES))).setIndentions(1).setSeparateStart());
