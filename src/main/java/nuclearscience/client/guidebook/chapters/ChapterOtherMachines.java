...
public class ChapterOtherMachines extends Chapter {
	...
	public void addData() {
		...
		// QUantum Capacitor
		pageData.add(new TextWrapperObject(NuclearScienceBlocks.blockQuantumCapacitor.asItem().getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setSeparateStart());
		...
		// Teleporter
		pageData.add(new TextWrapperObject(NuclearScienceBlocks.blockTeleporter.asItem().getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
		...
		// Atomic Assembler
		pageData.add(new TextWrapperObject(NuclearScienceBlocks.blockAtomicAssembler.asItem().getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
