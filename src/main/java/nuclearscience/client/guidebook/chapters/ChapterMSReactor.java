...
public class ChapterMSReactor extends Chapter {
    ...
    public void addData() {
        ...
        pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook(
                ...
                //
                NuclearScienceItems.ITEMS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.msreactorcore).getDescription().copy().withStyle(TextFormatting.BOLD),
                //
                NuclearScienceItems.ITEMS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.freezeplug).getDescription().copy().withStyle(TextFormatting.BOLD),
                //
                NuclearScienceItems.ITEMS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.moltensaltsupplier).getDescription().copy().withStyle(TextFormatting.BOLD)
                //
        ...
        pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook(
                ...
                //
                NuclearScienceItems.ITEMS_MOLTENSALTPIPTE.getValue(SubtypeMoltenSaltPipe.vanadiumsteelceramic).getDescription().copy().withStyle(TextFormatting.BOLD),
                //
                NuclearScienceItems.ITEMS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.heatexchanger).getDescription().copy().withStyle(TextFormatting.BOLD)
                //
        )).setIndentions(1).setSeparateStart());
        ...
        pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook("chapter.msreactor.l6", NuclearScienceItems.ITEMS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.mscontrolrod).getDescription().copy().withStyle(TextFormatting.BOLD))).setIndentions(1).setSeparateStart());
