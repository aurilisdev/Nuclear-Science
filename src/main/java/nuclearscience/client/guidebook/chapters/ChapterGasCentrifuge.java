...
public class ChapterGasCentrifuge extends Chapter {
    ...
    private static final ItemWrapperObject LOGO = new ItemWrapperObject(7, 10, 32, 32, 32, 2.0F,
	    NuclearScienceItems.ITEMS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.gascentrifuge));
	...
	pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook("chapter.centrifuge.l2")).setSeparateStart()
		.setIndentions(1));
	pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 75, 150, 75,
		NuclearScience.rl("textures/screen/guidebook/gascentrifuge1.png")));
	pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 75, 150, 75,
		NuclearScience.rl("textures/screen/guidebook/gascentrifuge2.png")));
    }
