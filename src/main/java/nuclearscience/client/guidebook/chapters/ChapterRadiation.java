...
public class ChapterRadiation extends Chapter {
	...
	protected List<Page> genPages() {
		...
		pages.add(new Page(new TextWrapperObject[] { new TextWrapperObject(10, 40, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l1"), new TextWrapperObject(10, 50, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l2"), new TextWrapperObject(10, 60, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l3"), new TextWrapperObject(10, 70, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l4"), new TextWrapperObject(10, 80, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l5-1"), new TextWrapperObject(70, 80, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l5-2").setTextStyles(ChatFormatting.BOLD), new TextWrapperObject(10, 90, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l6"), new TextWrapperObject(10, 100, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l7"), new TextWrapperObject(10, 110, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l8"), new TextWrapperObject(10, 120, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l9"), new TextWrapperObject(10, 130, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l10"), new TextWrapperObject(10, 140, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l11"), new TextWrapperObject(10, 150, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l12"), new TextWrapperObject(10, 160, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l13"), new TextWrapperObject(10, 170, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l14-1"), new TextWrapperObject(60, 170, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l14-2").setTextStyles(ChatFormatting.BOLD), new TextWrapperObject(100, 170, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l14-3"), new TextWrapperObject(10, 180, 4210752, "guidebook.nuclearscience.chapter.radiation.p2l15"), }));
		return pages;
	}
