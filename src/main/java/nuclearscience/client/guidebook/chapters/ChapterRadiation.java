...
public class ChapterRadiation extends Chapter {
	...
	public void addData() {
		...
		pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook("chapter.radiation.l4",
				...
				//
				new TextComponent("" + VoltaicConstants.IODINE_RESISTANCE_THRESHHOLD).withStyle(ChatFormatting.BOLD),
				//
				new TextComponent("" + ItemIodineTablet.TIME_MINUTES).withStyle(ChatFormatting.BOLD),
				//
