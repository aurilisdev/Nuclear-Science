...
public class ChapterTurbines extends Chapter {
    ...
    private static final ItemWrapperObject LOGO = new ItemWrapperObject(7, 10, 32, 32, 32, 2.0F,
	    NuclearScienceItems.ITEM_TURBINE.get());
	...
	pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook("chapter.turbines.tempvoltage", 1090, 120))
		.setIndentions(1).setSeparateStart());
	pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook("chapter.turbines.tempvoltage", 1515, 240))
		.setIndentions(1).setSeparateStart());
	pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook("chapter.turbines.tempvoltage", ">1515", 480))
		.setIndentions(1).setSeparateStart());
	pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook("chapter.turbines.l2")).setSeparateStart());
	pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook("chapter.turbines.l3")).setIndentions(1)
		.setSeparateStart());
