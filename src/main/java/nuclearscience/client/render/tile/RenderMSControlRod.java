...
public class RenderMSControlRod extends AbstractTileRenderer<TileControlRod.TileMSControlRod> {
    ...
    public RenderMSControlRod(TileEntityRendererDispatcher context) {
        super(context);
    }

    @Override
    public void render(@Nonnull TileControlRod.TileMSControlRod tile, float partialTicks, MatrixStack stack, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
