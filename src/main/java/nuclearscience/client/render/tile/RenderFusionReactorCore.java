...
public class RenderFusionReactorCore extends TileEntityRenderer<TileFusionReactorCore> {
	...
	public static void renderFloatingText(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, String text, float x, float y, float z, int color, int combinedLightIn) {
