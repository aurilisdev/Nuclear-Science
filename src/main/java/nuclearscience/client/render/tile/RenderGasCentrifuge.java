...
public class RenderGasCentrifuge extends TileEntityRenderer<TileGasCentrifuge> {
    ...
    @Override
    public void render(TileGasCentrifuge tileEntityIn, float partialTicks, MatrixStack matrixStackIn,
	...
	Minecraft.getInstance().getBlockRendererDispatcher().getBlockModelRenderer().renderModel(
		...
		matrixStackIn, bufferIn.getBuffer(RenderType.getCutoutMipped()), false, tileEntityIn.getWorld().rand,
