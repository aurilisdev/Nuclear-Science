...
public class RenderElectromagneticGateway extends AbstractTileRenderer<TileElectromagneticGateway> {
    ...
    private static final AABB BOX2 = new AABB(15.0 / 16.0, 1.0 / 16.0, 1.0 / 16.0, 16.0 / 16.0, 15.0 / 16.0,
	    15.0 / 16.0);
    private static final AABB BOX3 = new AABB(1.0 / 16.0, 0.0 / 16.0, 0.0 / 16.0, 15.0 / 16.0, 15.0 / 16.0, 1.0 / 16.0);
    private static final AABB BOX4 = new AABB(1.0 / 16.0, 1.0 / 16.0, 15.0 / 16.0, 15.0 / 16.0, 15.0 / 16.0,
	    16.0 / 16.0);
	...
	TextureAtlasSprite texture = NuclearScienceClientRegister
		.getSprite(NuclearScienceClientRegister.TEXTURE_GATEWAYLASER);

	RenderingUtils.renderFilledBoxNoOverlay(matrix, bufferIn.getBuffer(RenderType.translucent()), BOX1,
	...
	RenderingUtils.renderFilledBoxNoOverlay(matrix, bufferIn.getBuffer(RenderType.translucent()), BOX2,
		COLOR.rFloat(), COLOR.gFloat(), COLOR.bFloat(), COLOR.aFloat(), texture.getU0(), texture.getV0(),
		texture.getU1(), texture.getV1(), combinedLightIn, FACES);
	RenderingUtils.renderFilledBoxNoOverlay(matrix, bufferIn.getBuffer(RenderType.translucent()), BOX3,
		COLOR.rFloat(), COLOR.gFloat(), COLOR.bFloat(), COLOR.aFloat(), texture.getU0(), texture.getV0(),
		texture.getU1(), texture.getV1(), combinedLightIn, FACES);
	RenderingUtils.renderFilledBoxNoOverlay(matrix, bufferIn.getBuffer(RenderType.translucent()), BOX4,
		COLOR.rFloat(), COLOR.gFloat(), COLOR.bFloat(), COLOR.aFloat(), texture.getU0(), texture.getV0(),
		texture.getU1(), texture.getV1(), combinedLightIn, FACES);
