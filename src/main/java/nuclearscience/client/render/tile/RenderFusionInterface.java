...
public class RenderFusionInterface extends AbstractTileRenderer<TileFusionInterface> {
    ...
    public static final AxisAlignedBB FUEL_CELL = new AxisAlignedBB(6.0 / 16.0, 2.0 / 16.0, 6.0 / 16.0, 10.0 / 16.0, 15.0 / 16.0, 10.0 / 16.0);
    public static final AxisAlignedBB FUEL_CELL_PISTON = new AxisAlignedBB(5.0 / 16.0, FLOOR_Y, 5.0 / 16.0, 11.0 / 16.0, FLOOR_Y + 1.0 / 16.0, 11.0 / 16.0);

    public RenderFusionInterface(TileEntityRendererDispatcher context) {
        super(context);
    }
            ...
            switch (animation) {
                ...
                case FUSION_TRITIUM_INSERT:
                    ...
                    if(perc < 0.5) {
                        ...
                        pistonRod = new AxisAlignedBB(7.0 / 16.0, FLOOR_Y, 7.0 / 16.0, 9.0 / 16.0, FLOOR_Y + y, 9.0 / 16.0);
