...
public class RenderFissionInterface extends AbstractTileRenderer<TileFissionInterface> {
    ...
    public static final AABB FUEL_ROD_PISTON_1 = new AABB(3.0 / 16.0, FLOOR_Y, 3.0 / 16.0, 4.0 / 16.0,
	    FLOOR_Y + 0.8 / 16.0, 4.0 / 16.0);
    public static final AABB FUEL_ROD_PISTON_2 = new AABB(12.0 / 16.0, FLOOR_Y, 3.0 / 16.0, 13.0 / 16.0,
	    FLOOR_Y + 0.8 / 16.0, 4.0 / 16.0);
    public static final AABB FUEL_ROD_PISTON_3 = new AABB(12.0 / 16.0, FLOOR_Y, 12.0 / 16.0, 13.0 / 16.0,
	    FLOOR_Y + 0.8 / 16.0, 13.0 / 16.0);
    public static final AABB FUEL_ROD_PISTON_4 = new AABB(3.0 / 16.0, FLOOR_Y, 12.0 / 16.0, 4.0 / 16.0,
	    FLOOR_Y + 0.8 / 16.0, 13.0 / 16.0);

    public static final AABB TRITIUM_CELL_PISTON = new AABB(7.0 / 16.0, FLOOR_Y, 7.0 / 16.0, 9.0 / 16.0,
	    FLOOR_Y + 0.8 / 16.0, 9.0 / 16.0);
    ...
    @Override
    public void render(TileFissionInterface tile, float partialTicks, PoseStack matrix, MultiBufferSource bufferIn,
	...
	tile.clientAnimations.forEach((animation, recieved) -> {
		...
		if (perc > 0.5) {
		    ...
		    renderBox(matrix, pistonRod, PISTON_ROD_GRAY, white, bufferIn, combinedLightIn,
			    RenderingUtils.ALL_FACES);

		    matrix.translate(0, y, 0);

		    renderBox(matrix, RenderFissionReactorCore.FUEL_ROD_1, RenderFissionReactorCore.SPENT, fuelCell,
			    bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
		} else {
		...
		if (perc > 0.5) {
		    ...
		    renderBox(matrix, RenderFissionReactorCore.FUEL_ROD_2, RenderFissionReactorCore.SPENT, fuelCell,
			    bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
		} else {
		...
		if (perc > 0.5) {
		    ...
		    renderBox(matrix, RenderFissionReactorCore.FUEL_ROD_3, RenderFissionReactorCore.SPENT, fuelCell,
			    bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
		} else {
		...
		if (perc > 0.5) {
		    ...
		    renderBox(matrix, RenderFissionReactorCore.FUEL_ROD_4, RenderFissionReactorCore.SPENT, fuelCell,
			    bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
		} else {
		...
		if (perc < 0.5) {
		    ...
		    renderBox(matrix, RenderFissionReactorCore.FUEL_ROD_1,
			    RenderFissionReactorCore.getColorFromFuel(coreInv.getItem(0)), fuelCell, bufferIn,
		...
		if (perc < 0.5) {
		    ...
		    renderBox(matrix, RenderFissionReactorCore.FUEL_ROD_2,
			    RenderFissionReactorCore.getColorFromFuel(coreInv.getItem(1)), fuelCell, bufferIn,
			    combinedLightIn, RenderingUtils.ALL_FACES);
		} else {
		...
		if (perc < 0.5) {
		    ...
		    renderBox(matrix, RenderFissionReactorCore.FUEL_ROD_3,
			    RenderFissionReactorCore.getColorFromFuel(coreInv.getItem(2)), fuelCell, bufferIn,
			    combinedLightIn, RenderingUtils.ALL_FACES);
		} else {
		...
		if (perc < 0.5) {
		    ...
		    renderBox(matrix, RenderFissionReactorCore.FUEL_ROD_4,
			    RenderFissionReactorCore.getColorFromFuel(coreInv.getItem(3)), fuelCell, bufferIn,
			    combinedLightIn, RenderingUtils.ALL_FACES);
		} else {
		...
		if (perc > 0.5) {
		    ...
		    renderBox(matrix, RenderFissionReactorCore.TRITIUM_CELL, RenderFissionReactorCore.TRITIUM, fuelCell,
			    bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
		} else {
		...
		if (perc < 0.5) {
		    ...
		    renderBox(matrix, RenderFissionReactorCore.TRITIUM_CELL, RenderFissionReactorCore.DEUTERIUM,
			    fuelCell, bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
		} else {
