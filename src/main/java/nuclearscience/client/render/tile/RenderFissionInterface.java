...
public class RenderFissionInterface extends AbstractTileRenderer<TileFissionInterface> {
    ...
    public static final AxisAlignedBB FUEL_ROD_PISTON_1 = new AxisAlignedBB(3.0 / 16.0, FLOOR_Y, 3.0 / 16.0, 4.0 / 16.0, FLOOR_Y + 0.8 / 16.0, 4.0 / 16.0);
    public static final AxisAlignedBB FUEL_ROD_PISTON_2 = new AxisAlignedBB(12.0 / 16.0, FLOOR_Y, 3.0 / 16.0, 13.0 / 16.0, FLOOR_Y + 0.8 / 16.0, 4.0 / 16.0);
    public static final AxisAlignedBB FUEL_ROD_PISTON_3 = new AxisAlignedBB(12.0 / 16.0, FLOOR_Y, 12.0 / 16.0, 13.0 / 16.0, FLOOR_Y + 0.8 / 16.0, 13.0 / 16.0);
    public static final AxisAlignedBB FUEL_ROD_PISTON_4 = new AxisAlignedBB(3.0 / 16.0, FLOOR_Y, 12.0 / 16.0, 4.0 / 16.0, FLOOR_Y + 0.8 / 16.0, 13.0 / 16.0);

    public static final AxisAlignedBB TRITIUM_CELL_PISTON = new AxisAlignedBB(7.0 / 16.0, FLOOR_Y, 7.0 / 16.0, 9.0 / 16.0, FLOOR_Y + 0.8 / 16.0, 9.0 / 16.0);
    ...
    public RenderFissionInterface(TileEntityRendererDispatcher context) {
        super(context);
    }

    @Override
    public void render(TileFissionInterface tile, float partialTicks, MatrixStack matrix, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
            ...
            switch (animation) {
                ...
                case FISSION_WASTE_1:
                    ...
                    if (perc > 0.5) {
                        ...
                        pistonRod = new AxisAlignedBB(3.25 / 16.0, FLOOR_Y, 3.25 / 16.0, 3.75 / 16.0, FLOOR_Y + y, 3.75 / 16.0);
		...
		renderBox(matrix, FUEL_ROD_PISTON_1, PISTON_HEAD_GRAY, white, bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
                ...
                case FISSION_WASTE_2:
                    ...
                    if (perc > 0.5) {
                        ...
                        pistonRod = new AxisAlignedBB(12.25 / 16.0, FLOOR_Y, 3.25 / 16.0, 12.75 / 16.0, FLOOR_Y + y, 3.75 / 16.0);
                        renderBox(matrix, pistonRod, PISTON_ROD_GRAY, white, bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
		...
		renderBox(matrix, FUEL_ROD_PISTON_2, PISTON_HEAD_GRAY, white, bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
                ...
                case FISSION_WASTE_3:
                    ...
                    if (perc > 0.5) {
                        ...
                        pistonRod = new AxisAlignedBB(12.25 / 16.0, FLOOR_Y, 12.25 / 16.0, 12.75 / 16.0, FLOOR_Y + y, 12.75 / 16.0);
                        renderBox(matrix, pistonRod, PISTON_ROD_GRAY, white, bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
		...
		renderBox(matrix, FUEL_ROD_PISTON_3, PISTON_HEAD_GRAY, white, bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
                ...
                case FISSION_WASTE_4:
                    ...
                    if (perc > 0.5) {
                        ...
                        pistonRod = new AxisAlignedBB(3.25 / 16.0, FLOOR_Y, 12.25 / 16.0, 3.75 / 16.0, FLOOR_Y + y, 12.75 / 16.0);
                        renderBox(matrix, pistonRod, PISTON_ROD_GRAY, white, bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
		...
		renderBox(matrix, FUEL_ROD_PISTON_4, PISTON_HEAD_GRAY, white, bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
                ...
                case FISSION_TRITIUM_EXTRACT:
                    ...
                    if (perc > 0.5) {
                        ...
                        pistonRod = new AxisAlignedBB(7.25 / 16.0, FLOOR_Y, 7.25 / 16.0, 8.75 / 16.0, FLOOR_Y + y, 8.75 / 16.0);
                        renderBox(matrix, pistonRod, PISTON_ROD_GRAY, white, bufferIn, combinedLightIn, RenderingUtils.ALL_FACES);
    ...
    private void renderBox(MatrixStack matrix, AxisAlignedBB box, Color color, TextureAtlasSprite texture, IRenderTypeBuffer bufferIn, int combinedLightIn, boolean[] faces) {
