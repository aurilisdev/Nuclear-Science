...
public class RenderQuantumTunnel extends AbstractTileRenderer<TileQuantumTunnel> {
	...
	public RenderQuantumTunnel(TileEntityRendererDispatcher context) {
		super(context);
	}

	@Override
	public void render(TileQuantumTunnel tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
