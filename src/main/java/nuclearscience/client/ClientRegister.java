...
public class ClientRegister {
	...
	public static void onModelEvent(ModelRegistryEvent event) {
		...
		ForgeModelBakery.addSpecialModel(MODEL_FISSIONREACTORCORE);
		ForgeModelBakery.addSpecialModel(MODEL_FISSIONREACTORFUELROD);
		ForgeModelBakery.addSpecialModel(MODEL_FISSIONREACTORDEUTERIUM);
