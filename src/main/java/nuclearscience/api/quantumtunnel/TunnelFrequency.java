...
public class TunnelFrequency {
    ...
    public static final StreamCodec<PacketBuffer, TunnelFrequency> STREAM_CODEC = new StreamCodec<PacketBuffer, TunnelFrequency>() {
		
		@Override
		public void encode(PacketBuffer buffer, TunnelFrequency value) {
		...
		@Override
		public TunnelFrequency decode(PacketBuffer buffer) {
    ...
    public static TunnelFrequency createPrivate(UUID id, PlayerEntity creator, String name) {
        return new TunnelFrequency(id, creator.getUUID(), name, creator.getName().getString(), FrequencyType.PRIVATE.ordinal());
    }


    public static TunnelFrequency createPublic(UUID id, PlayerEntity creator, String name) {
