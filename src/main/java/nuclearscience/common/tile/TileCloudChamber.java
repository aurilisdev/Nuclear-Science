...
public class TileCloudChamber extends GenericTile {
    ...
    public TileCloudChamber() {
        super(NuclearScienceTiles.TILE_CLOUDCHAMBER.get());
        ...
        addComponent(new ComponentContainerProvider("cloudchamber", this).createMenu((id, player) -> new ContainerCloudChamber(id, player, new Inventory(), getCoordsArray())));
