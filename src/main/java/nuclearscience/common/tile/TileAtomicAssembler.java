...
public class TileAtomicAssembler extends GenericTile {
	...
	private boolean validateDupeItem(ItemStack stack) {
		...
		if (ItemUtils.testItems(stack.getItem(), NuclearScienceItems.ITEM_CELLDARKMATTER.get()) && stack.getCapability(ForgeCapabilities.ITEM_HANDLER).orElse(CapabilityUtils.EMPTY_ITEM_HANDLER) != CapabilityUtils.EMPTY_ITEM_HANDLER) {
			return false;
		}
