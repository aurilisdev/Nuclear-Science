...
public class TileElectromagneticGateway extends GenericTile {
    ...
    public TileElectromagneticGateway() {
        super(NuclearScienceTiles.TILE_ELECTROMAGNETICGATEWAY.get());
        addComponent(new ComponentTickable(this));
        addComponent(new ComponentContainerProvider("electromagneticgateway", this).createMenu((id, player) -> new ContainerElectromagneticGateway(id, player, new Inventory(0), getCoordsArray())));
    }
