...
public class TileParticleInjector extends GenericTile {
	...
	public TileParticleInjector() {
		super(NuclearScienceTiles.TILE_PARTICLEINJECTOR.get());
	...
	public boolean handleCollision() {
		...
		if(!level.isClientSide()) {
			...
			level.playSound(null, pos, SoundEvents.END_PORTAL_SPAWN, SoundCategory.BLOCKS, 1, 1);
			...
			for(int i = 0; i < 50; i++) {
				...
				((ServerWorld) level).sendParticles(ParticleTypes.PORTAL, d0, d1, d2, 1, 0, 0, 0, d3);
			}
