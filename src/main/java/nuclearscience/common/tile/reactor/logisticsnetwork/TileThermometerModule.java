...
public class TileThermometerModule extends GenericTileInterfaceBound {
    ...
    public void tickServer(ComponentTickable tickable) {
        ...
        TileEntity blockentity = genericInterface.reactor.getSafe();

        if (blockentity instanceof TileFissionReactorCore) {

            temp = TileFissionReactorCore.getActualTemp(((TileFissionReactorCore) blockentity).temperature.getValue());

        } else if (blockentity instanceof TileMSReactorCore) {

            temp = ((TileMSReactorCore) blockentity).temperature.getValue();
