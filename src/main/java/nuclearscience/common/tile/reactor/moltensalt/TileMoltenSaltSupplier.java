...
public class TileMoltenSaltSupplier extends GenericTile {
	...
	addComponent(new ComponentElectrodynamic(this, false, true).voltage(NuclearConstants.MOLTENSALTSUPPLIER_VOLTAGE)
		.extractPower((x, y) -> TransferPack.EMPTY).setInputDirections(BlockEntityUtils.MachineDirection.BOTTOM)
		.maxJoules(NuclearConstants.MOLTENSALTSUPPLIER_USAGE_PER_TICK * 20));
	...
	RadiationUtils.handleRadioactiveItems(this, inv, NuclearConstants.MOLTEN_SAL_SUPPLIER_RADIATION_RADIUS, true,
		30, true, false);
