...
public class ItemHazmatArmor extends ItemVoltaicArmor implements IHazmatSuit {
    ...
    public ItemHazmatArmor(ArmorMaterial materialIn, Type slot, Properties properties, double radiationProtection,
	    double radiationStrengthRating, Supplier<CreativeModeTab> creativeTab) {
    ...
    public ItemHazmatArmor(Type slot, Properties properties, double radiationProtection, double radiationStrengthRating,
	...
	return NuclearScience.ID + ":textures/block/model/"
		+ (material == ArmorMaterialHazmat.hazmat ? "" : "reinforced") + "hazmatarmor.png";
    }

    public enum ArmorMaterialHazmat implements ArmorMaterial {
	hazmat, reinforcedhazmat;
	...
	public Ingredient getRepairIngredient() {
	    return Ingredient
		    .of(this == hazmat ? Items.LEATHER : ElectrodynamicsItems.ITEMS_PLATE.getValue(SubtypePlate.lead));
	}
