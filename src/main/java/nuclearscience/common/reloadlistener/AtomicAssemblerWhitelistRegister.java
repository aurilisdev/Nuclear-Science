...
public class AtomicAssemblerWhitelistRegister extends AbstractReloadListener<JsonObject> {
	...
	private final HashSet<INamedTag<Item>> tags = new HashSet<>();
	...
	protected JsonObject prepare(IResourceManager manager, IProfiler profiler) {
		...
		List<ResourceLocation> resources = new ArrayList<>(manager.listResources(FOLDER, AtomicAssemblerWhitelistRegister::isStringJsonFile));
