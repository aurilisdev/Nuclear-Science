...
public class ContainerReactorCore extends GenericContainer<TileReactorCore> {
	...
	addSlot(new SlotRestricted(inv, nextIndex(), 80, 11, DeferredRegisters.ITEM_FUELHEUO2.get(),
		DeferredRegisters.ITEM_FUELLEUO2.get()));
	addSlot(new SlotRestricted(inv, nextIndex(), 152, 11, DeferredRegisters.ITEM_FUELHEUO2.get(),
		DeferredRegisters.ITEM_FUELLEUO2.get()));
	addSlot(new SlotRestricted(inv, nextIndex(), 80, 47, DeferredRegisters.ITEM_FUELHEUO2.get(),
		DeferredRegisters.ITEM_FUELLEUO2.get()));
	addSlot(new SlotRestricted(inv, nextIndex(), 152, 47, DeferredRegisters.ITEM_FUELHEUO2.get(),
		DeferredRegisters.ITEM_FUELLEUO2.get()));
