...
public class ContainerFissionReactorCore extends GenericContainerBlockEntity<TileFissionReactorCore> {
	...
	addSlot(new SlotRestricted(ScreenComponentSlot.SlotType.NORMAL, NuclearIconTypes.FUEL_CELL_DARK, inv,
		nextIndex(), 32, 21)
		.setRestriction(NuclearScienceItems.ITEM_FUELHEUO2.get(), NuclearScienceItems.ITEM_FUELLEUO2.get(),
			NuclearScienceItems.ITEM_FUELPLUTONIUM.get())
	...
	addSlot(new SlotRestricted(ScreenComponentSlot.SlotType.NORMAL, NuclearIconTypes.FUEL_CELL_DARK, inv,
		...
		.setRestriction(NuclearScienceItems.ITEM_FUELHEUO2.get(), NuclearScienceItems.ITEM_FUELLEUO2.get(),
			NuclearScienceItems.ITEM_FUELPLUTONIUM.get())
		.setIOColor(new Color(0, 255, 30, 255)));
	addSlot(new SlotRestricted(inv, nextIndex(), 55, 39)
		.setRestriction(NuclearScienceItems.ITEM_CELLDEUTERIUM.get()).setIOColor(new Color(0, 240, 255, 255)));
