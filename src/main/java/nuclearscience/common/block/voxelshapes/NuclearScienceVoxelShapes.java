...
public class NuclearScienceVoxelShapes {
    ...
    public static final VoxelShapeProvider FISSION_REACTOR_CORE = VoxelShapeProvider.createOmni(
            ...
            Stream.of(
                    //
                    VoxelShapes.box(0.40625, 0.115675, 0.40625, 0.59375, 0.7088875, 0.59375),
                    //
                    VoxelShapes.box(0.25, 0.06565, 0.125, 0.75, 0.1148875, 0.1875),
                    //
                    VoxelShapes.box(0.84375, 0.7878, 0.25, 0.90625, 0.8370375, 0.75),
                    //
                    VoxelShapes.box(0.8125, 0.06565, 0.25, 0.875, 0.1148875, 0.75),
                    //
                    VoxelShapes.box(0.0625, 0.72215, 0.125, 0.125, 0.7878, 0.875),
                    //
                    VoxelShapes.box(0.1875, 0.06565, 0.875, 0.25, 0.72215, 0.9375),
                    //
                    VoxelShapes.box(0.1875, 0.06565, 0.0625, 0.25, 0.72215, 0.125),
                    //
                    VoxelShapes.box(0.25, 0.06565, 0.25, 0.3125, 0.72215, 0.3125),
                    //
                    VoxelShapes.box(0.25, 0.06565, 0.6875, 0.3125, 0.72215, 0.75),
                    //
                    VoxelShapes.box(0.6875, 0.06565, 0.25, 0.75, 0.72215, 0.3125),
                    //
                    VoxelShapes.box(0.6875, 0.06565, 0.6875, 0.75, 0.72215, 0.75),
                    //
                    VoxelShapes.box(0.75, 0.06565, 0.875, 0.8125, 0.72215, 0.9375),
                    //
                    VoxelShapes.box(0.75, 0.06565, 0.0625, 0.8125, 0.72215, 0.125),
                    //
                    VoxelShapes.box(0.0625, 0.06565, 0.75, 0.125, 0.72215, 0.8125),
                    //
                    VoxelShapes.box(0.0625, 0.06565, 0.1875, 0.125, 0.72215, 0.25),
                    //
                    VoxelShapes.box(0.875, 0.06565, 0.75, 0.9375, 0.72215, 0.8125),
                    //
                    VoxelShapes.box(0.875, 0.06565, 0.1875, 0.9375, 0.72215, 0.25),
                    //
                    VoxelShapes.box(0.0625, 0, 0.125, 0.125, 0.06565, 0.875),
                    //
                    VoxelShapes.box(0.09375, 0.7878, 0.25, 0.15625, 0.8370375, 0.75),
                    //
                    VoxelShapes.box(0.125, 0.06565, 0.25, 0.1875, 0.1148875, 0.75),
                    //
                    VoxelShapes.box(0.875, 0, 0.125, 0.9375, 0.06565, 0.875),
                    //
                    VoxelShapes.box(0.125, 0, 0.0625, 0.875, 0.06565, 0.9375),
                    //
                    VoxelShapes.box(0.125, 0.72215, 0.0625, 0.875, 0.7878, 0.9375),
                    //
                    VoxelShapes.box(0.15625, 0.7878, 0.15625, 0.84375, 0.8370375, 0.84375),
                    //
                    VoxelShapes.box(0.1875, 0.06565, 0.1875, 0.8125, 0.1148875, 0.8125),
                    //
                    VoxelShapes.box(0.1875, 0.8370375, 0.1875, 0.8125, 0.886275, 0.8125),
                    //
                    VoxelShapes.box(0.25, 0.886275, 0.25, 0.75, 0.9355125, 0.75),
                    //
                    VoxelShapes.box(0.25, 0.7878, 0.84375, 0.75, 0.8370375, 0.90625),
                    //
                    VoxelShapes.box(0.25, 0.06565, 0.8125, 0.75, 0.1148875, 0.875),
                    //
                    VoxelShapes.box(0.875, 0.72215, 0.125, 0.9375, 0.7878, 0.875),
                    //
                    VoxelShapes.box(0.25, 0.7878, 0.09375, 0.75, 0.8370375, 0.15625)
                    //    
            ).reduce(VoxelShapes::or).get()
            //
    );
    ...
    public static final VoxelShapeProvider FREEZE_PLUG = VoxelShapeProvider.createOmni(
            ...
            Stream.of(
                    //
                    VoxelShapes.box(0.25, 0.15625, 0.25, 0.75, 0.28125, 0.75),
                    //
                    VoxelShapes.box(0.3125, 0.25, 0.3125, 0.6875, 0.8125, 0.6875),
                    //
                    VoxelShapes.box(0.125, 0.9375, 0.8125, 0.875, 1, 0.875),
                    //
                    VoxelShapes.box(0.125, 0.9375, 0.125, 0.875, 1, 0.1875),
                    //
                    VoxelShapes.box(0.1875, 0.875, 0.75, 0.8125, 0.9375, 0.8125),
                    //
                    VoxelShapes.box(0.25, 0.8125, 0.25, 0.75, 0.875, 0.75),
                    //
                    VoxelShapes.box(0.1875, 0.875, 0.1875, 0.8125, 0.9375, 0.25),
                    //
                    VoxelShapes.box(0.1875, 0.875, 0.25, 0.25, 0.9375, 0.75),
                    //
                    VoxelShapes.box(0.75, 0.875, 0.25, 0.8125, 0.9375, 0.75),
                    //
                    VoxelShapes.box(0.8125, 0.9375, 0.1875, 0.875, 1, 0.8125),
                    //
                    VoxelShapes.box(0.125, 0.9375, 0.1875, 0.1875, 1, 0.8125),
                    //
                    VoxelShapes.box(0.296875, 0.625, 0.296875, 0.703125, 0.6875, 0.703125),
                    //
                    VoxelShapes.box(0.28125, 0.5, 0.28125, 0.71875, 0.5625, 0.71875),
                    //
                    VoxelShapes.box(0.296875, 0.375, 0.296875, 0.703125, 0.4375, 0.703125),
                    //
                    VoxelShapes.box(0.078125, 0, 0.296875, 0.15625, 0.3125, 0.390625),
                    //
                    VoxelShapes.box(0.078125, 0, 0.453125, 0.15625, 0.3125, 0.546875),
                    //
                    VoxelShapes.box(0.078125, 0, 0.609375, 0.15625, 0.3125, 0.703125),
                    //
                    VoxelShapes.box(0.296875, 0, 0.84375, 0.390625, 0.3125, 0.921875),
                    //
                    VoxelShapes.box(0.453125, 0, 0.84375, 0.546875, 0.3125, 0.921875),
                    //
                    VoxelShapes.box(0.609375, 0, 0.84375, 0.703125, 0.3125, 0.921875),
                    //
                    VoxelShapes.box(0.84375, 0, 0.609375, 0.921875, 0.3125, 0.703125),
                    //
                    VoxelShapes.box(0.84375, 0, 0.453125, 0.921875, 0.3125, 0.546875),
                    //
                    VoxelShapes.box(0.84375, 0, 0.296875, 0.921875, 0.3125, 0.390625),
                    //
                    VoxelShapes.box(0.609375, 0, 0.078125, 0.703125, 0.3125, 0.15625),
                    //
                    VoxelShapes.box(0.453125, 0, 0.078125, 0.546875, 0.3125, 0.15625),
                    //
                    VoxelShapes.box(0.296875, 0, 0.078125, 0.390625, 0.3125, 0.15625),
                    //
                    VoxelShapes.box(0.625, 0.1875, 0.15625, 0.6875, 0.25, 0.25),
                    //
                    VoxelShapes.box(0.46875, 0.1875, 0.15625, 0.53125, 0.25, 0.25),
                    //
                    VoxelShapes.box(0.3125, 0.1875, 0.15625, 0.375, 0.25, 0.25),
                    //
                    VoxelShapes.box(0.15625, 0.1875, 0.3125, 0.25, 0.25, 0.375),
                    //
                    VoxelShapes.box(0.15625, 0.1875, 0.46875, 0.25, 0.25, 0.53125),
                    //
                    VoxelShapes.box(0.15625, 0.1875, 0.625, 0.25, 0.25, 0.6875),
                    //
                    VoxelShapes.box(0.3125, 0.1875, 0.75, 0.375, 0.25, 0.84375),
                    //
                    VoxelShapes.box(0.46875, 0.1875, 0.75, 0.53125, 0.25, 0.84375),
                    //
                    VoxelShapes.box(0.625, 0.1875, 0.75, 0.6875, 0.25, 0.84375),
                    //
                    VoxelShapes.box(0.75, 0.1875, 0.625, 0.84375, 0.25, 0.6875),
                    //
                    VoxelShapes.box(0.75, 0.1875, 0.46875, 0.84375, 0.25, 0.53125),
                    //
                    VoxelShapes.box(0.75, 0.1875, 0.3125, 0.84375, 0.25, 0.375),
                    //
                    VoxelShapes.box(0.3125, 0, 0.3125, 0.6875, 0.1875, 0.6875)
                    //    
            ).reduce(VoxelShapes::or).get()
            //
    );
