...
public enum SubtypeNuclearMachine implements ISubtype, IMachine {
    ...
    private SubtypeNuclearMachine(boolean showInItemGroup, TileEntitySupplier<TileEntity> blockEntitySupplier) {
        this(showInItemGroup, blockEntitySupplier, MachineProperties.DEFAULT);
    }

    private SubtypeNuclearMachine(boolean showInItemGroup, TileEntitySupplier<TileEntity> blockEntitySupplier, MachineProperties properties) {
