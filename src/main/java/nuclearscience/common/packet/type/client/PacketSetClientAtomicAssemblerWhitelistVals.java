...
public class PacketSetClientAtomicAssemblerWhitelistVals {
	...
	public static void encode(PacketSetClientAtomicAssemblerWhitelistVals pkt, PacketBuffer buf) {
	...
	public static PacketSetClientAtomicAssemblerWhitelistVals decode(PacketBuffer buf) {
