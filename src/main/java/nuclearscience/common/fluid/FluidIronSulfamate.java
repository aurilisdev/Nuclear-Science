...
public class FluidIronSulfamate extends Fluid {
    ...
    protected FluidAttributes createAttributes() {
		return FluidAttributes
			.builder(new ResourceLocation(References.ID + ":fluid/ironsulfamate"),
				new ResourceLocation(References.ID + ":fluid/ironsulfamate"))
			.translationKey("fluid.nuclearscience.ironsulfamate").build(this);
	}
