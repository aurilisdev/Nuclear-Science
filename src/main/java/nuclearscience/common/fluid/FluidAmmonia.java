...
public class FluidAmmonia extends Fluid {
    ...
    protected FluidAttributes createAttributes() {
		return FluidAttributes
			.builder(new ResourceLocation(References.ID + ":fluid/ammonia"),
				new ResourceLocation(References.ID + ":fluid/ammonia"))
			.translationKey("fluid.nuclearscience.ammonia").build(this);
	}
