...
public class MSRFuelPreProcessorRecipe extends FluidItem2ItemRecipe {
	...
	public MSRFuelPreProcessorRecipe(ResourceLocation location, CountableIngredient[] inputItems, FluidIngredient[] inputFluids, ItemStack outputItem, double experience, int ticks, double usagePerTick) {
		super(location, inputItems, inputFluids, outputItem, experience, ticks, usagePerTick);
	}
