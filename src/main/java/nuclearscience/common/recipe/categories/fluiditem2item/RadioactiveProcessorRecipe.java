...
public class RadioactiveProcessorRecipe extends FluidItem2ItemRecipe {
	...
	public RadioactiveProcessorRecipe(ResourceLocation group, List<CountableIngredient> itemInputs, List<FluidIngredient> fluidInputs, ItemStack itemOutput, double experience, int ticks, double usagePerTick, List<ProbableItem> itemBiproducts, List<ProbableFluid> fluidBiproducts) {
		super(group, itemInputs, fluidInputs, itemOutput, experience, ticks, usagePerTick, itemBiproducts, fluidBiproducts);
	}
	...
	public IRecipeType<?> getType() {
		return NuclearScienceRecipies.RADIOACTIVE_PROCESSOR_TYPE;
	}
