...
public class MSRFuelPreProcessorRecipe extends FluidItem2ItemRecipe {
	...
	public MSRFuelPreProcessorRecipe(ResourceLocation group, List<CountableIngredient> itemInputs, List<FluidIngredient> fluidInputs, ItemStack itemOutput, double experience, int ticks, double usagePerTick, List<ProbableItem> itemBiproducts, List<ProbableFluid> fluidBiproducts) {
	...
	public IRecipeType<?> getType() {
		return NuclearScienceRecipies.MSR_FUEL_PREPROCESSOR_TYPE;
	}
}
