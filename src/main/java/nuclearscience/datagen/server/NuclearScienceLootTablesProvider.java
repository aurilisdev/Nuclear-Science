...
public class NuclearScienceLootTablesProvider extends BaseLootTablesProvider {
	...
	protected void addTables() {
		...
		lootTables.put(NuclearScienceBlocks.BLOCKS_RADIATION_SHIELDING.getValue(SubtypeRadiationShielding.door), BlockLootTables.createDoorTable(NuclearScienceBlocks.BLOCKS_RADIATION_SHIELDING.getValue(SubtypeRadiationShielding.door)));
