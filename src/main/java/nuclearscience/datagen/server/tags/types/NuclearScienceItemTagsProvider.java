...
public class NuclearScienceItemTagsProvider extends ItemTagsProvider {
    ...
    public NuclearScienceItemTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider,
	...
	tag(NuclearScienceTags.Items.CELL_ANTIMATTER_VERY_LARGE)
		.add(NuclearScienceItems.ITEM_CELLANTIMATTERVERYLARGE.get());
