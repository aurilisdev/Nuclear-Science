...
public class NuclearScienceBlockTagsProvider extends BlockTagsProvider {
    ...
    public NuclearScienceBlockTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider,
	...
	tag(BlockTags.MINEABLE_WITH_PICKAXE)
		.add(NuclearScienceBlocks.BLOCKS_RADIATION_SHIELDING.getAllValuesArray(new Block[] {}))
		//
	...
	tag(BlockTags.MINEABLE_WITH_SHOVEL).add(
		NuclearScienceBlocks.BLOCKS_IRRADIATED.getValue(SubtypeIrradiatedBlock.soil),
		NuclearScienceBlocks.BLOCKS_IRRADIATED.getValue(SubtypeIrradiatedBlock.grass));

	tag(BlockTags.MINEABLE_WITH_AXE)
		.add(NuclearScienceBlocks.BLOCKS_IRRADIATED.getValue(SubtypeIrradiatedBlock.petrifiedwood));
	...
	tag(NuclearScienceTags.Blocks.FUSION_CONTAINMENT)
		.add(NuclearScienceBlocks.BLOCKS_ELECTROMAGENT.getAllValuesArray(new Block[0]));
