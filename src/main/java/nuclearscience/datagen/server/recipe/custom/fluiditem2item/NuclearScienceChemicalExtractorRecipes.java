...
public class NuclearScienceChemicalExtractorRecipes extends AbstractRecipeGenerator {
    ...
    public FluidItem2ItemBuilder<ChemicalExtractorRecipe> newRecipe(ItemStack stack, float xp, int ticks,
	    double usagePerTick, String name, String group) {
	return new FluidItem2ItemBuilder<>(ChemicalExtractorRecipe::new, stack,
		BaseRecipeBuilder.RecipeCategory.FLUID_ITEM_2_ITEM, modID, "chemical_extractor/" + name, group, xp,
		ticks, usagePerTick);
    }
