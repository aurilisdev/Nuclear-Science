...
public class NuclearScienceFissionReactorRecipes extends AbstractRecipeGenerator {
    ...
    public Item2ItemBuilder<FissionReactorRecipe> newRecipe(ItemStack stack, float xp, int ticks, double usagePerTick,
	    String name, String group) {
	return new Item2ItemBuilder<>(FissionReactorRecipe::new, stack, BaseRecipeBuilder.RecipeCategory.ITEM_2_ITEM,
		modID, "fission_reactor/" + name, group, xp, ticks, usagePerTick);
    }
