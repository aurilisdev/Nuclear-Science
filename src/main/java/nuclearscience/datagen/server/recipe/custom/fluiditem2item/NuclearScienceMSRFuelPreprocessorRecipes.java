...
public class NuclearScienceMSRFuelPreprocessorRecipes extends AbstractRecipeGenerator {
	...
	newRecipe(new ItemStack(NuclearScienceItems.ITEM_FLINAK.get()), 0.0F, MSRFUELPREPROCESSOR_REQUIRED_TICKS,
		MSRFUELPREPROCESSOR_USAGE_PER_TICK, "flinak", modID)
		//
	...
	newRecipe(new ItemStack(NuclearScienceItems.ITEM_LIFHT4PUF3.get()), 0.0F, MSRFUELPREPROCESSOR_REQUIRED_TICKS,
		MSRFUELPREPROCESSOR_USAGE_PER_TICK, "lifthf4uf4", modID)
		//
		.addItemTagInput(VoltaicTags.Items.DUST_LITHIUM, 1)
		//
    ...
    public FluidItem2ItemBuilder<MSRFuelPreProcessorRecipe> newRecipe(ItemStack stack, float xp, int ticks,
	    double usagePerTick, String name, String group) {
	return new FluidItem2ItemBuilder<>(MSRFuelPreProcessorRecipe::new, stack,
		BaseRecipeBuilder.RecipeCategory.FLUID_ITEM_2_ITEM, modID, "msr_fuel_preprocessor/" + name, group, xp,
		ticks, usagePerTick);
    }
