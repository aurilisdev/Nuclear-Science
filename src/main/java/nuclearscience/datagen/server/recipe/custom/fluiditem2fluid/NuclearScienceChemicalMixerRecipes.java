...
public class NuclearScienceChemicalMixerRecipes extends ElectrodynamicsChemicalMixerRecipes {
	...
	newRecipe(new FluidStack(ElectrodynamicsFluids.FLUID_AMMONIA.get(), 1000), 0, CHEMICALMIXER_REQUIRED_TICKS,
		CHEMICALMIXER_USAGE_PER_TICK, "ammonia")
		//
	...
	newRecipe(new FluidStack(ElectrodynamicsFluids.FLUIDS_SULFATE.getValue(SubtypeSulfateFluid.iron), 1000), 0,
		CHEMICALMIXER_REQUIRED_TICKS, CHEMICALMIXER_USAGE_PER_TICK, "ironsulfate_from_ironblock")
		//
	...
	newRecipe(new FluidStack(NuclearScienceFluids.FLUID_IODINESOLUTION.get(), 100), 0, CHEMICALMIXER_REQUIRED_TICKS,
		CHEMICALMIXER_USAGE_PER_TICK, "iodine_solution_from_eggs")
		//
	...
	newRecipe(new FluidStack(NuclearScienceFluids.FLUID_IODINESOLUTION.get(), 100), 0, CHEMICALMIXER_REQUIRED_TICKS,
		CHEMICALMIXER_USAGE_PER_TICK, "iodine_solution_from_kelp")
		//
		.addFluidTagInput(VoltaicTags.Fluids.SULFURIC_ACID, 200)
		//
	...
	newRecipe(new FluidStack(NuclearScienceFluids.FLUID_DECONTAMINATIONFOAM.get(), 1000), 0, 100, 1000,
		"decontamination_foam")
		//
		.addFluidTagInput(VoltaicTags.Fluids.AMMONIA, 1000)
		//
		.addItemStackInput(
			new ItemStack(ElectrodynamicsItems.ITEMS_CRYSTAL.getValue(SubtypeCrystal.potassiumchloride), 2))
		//
		.complete(consumer);
