...
public class NuclearScienceLangKeyProvider extends BaseLangKeyProvider {
	...
	public NuclearScienceLangKeyProvider(DataGenerator gen, Locale locale) {
		super(gen, locale, NuclearScience.ID);
	}
	...
	protected void addTranslations() {
		...
		default:
			...
			addFluid(NuclearScienceFluids.FLUID_STEAM, "Steam");
			addFluid(NuclearScienceFluids.FLUID_URANIUMHEXAFLUORIDE, "Uranium Hexafluoride");
