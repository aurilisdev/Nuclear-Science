...
public class NuclearScienceLangKeyProvider extends BaseLangKeyProvider {
	...
	protected void addTranslations() {
		...
		default:
			...
			addGuidebook("chapter.othermachines.atomicassembler3", "Each duplication takes 6000 ticks, and will take one use of the Dark Matter Cells. This is equivalent to 5 minutes. Cells have 12 uses in total.");
