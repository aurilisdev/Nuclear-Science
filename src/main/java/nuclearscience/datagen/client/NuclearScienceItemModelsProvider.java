...
public class NuclearScienceItemModelsProvider extends BaseItemModelsProvider {
	...
	layeredItem(NuclearScienceItems.ITEM_CELLANTIMATTERVERYLARGE, Parent.GENERATED,
		itemLoc("cellantimatterverylarge"));
	...
	layeredBuilder(name(NuclearScienceItems.ITEM_FREQUENCYCARD), Parent.GENERATED, itemLoc("frequencycard"))
	...
	layeredItem(NuclearScienceItems.ITEM_REINFORCEDHAZMATHELMET, Parent.GENERATED,
		itemLoc("reinforcedhazmathelmet"));
	...
	simpleBlockItem(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.atomicassembler),
		existingBlock(blockLoc("atomicassemblersingle")));
	simpleBlockItem(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.fissioncontrolrod),
		existingBlock(blockLoc("fissioncontrolroditem")));
	simpleBlockItem(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.mscontrolrod),
		existingBlock(blockLoc("mscontrolroditem")));
	simpleBlockItem(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.gascentrifuge),
		existingBlock(blockLoc("gascentrifuge")));
	layeredItem(NuclearScienceItems.ITEMS_MOLTENSALTPIPTE.getValue(SubtypeMoltenSaltPipe.vanadiumsteelceramic),
		Parent.GENERATED, itemLoc("pipe/" + SubtypeMoltenSaltPipe.vanadiumsteelceramic.tag()));
	simpleBlockItem(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.particleinjector),
		existingBlock(blockLoc("particleinjector"))).transforms().transform(ItemDisplayContext.GUI)
		.rotation(45.0F, 45.0F, 0).scale(0.5F).translation(0.0F, -1.0F, 0.0F);
	simpleBlockItem(NuclearScienceBlocks.BLOCK_TURBINE.get(), existingBlock(blockLoc("turbine")));
	simpleBlockItem(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.falloutscrubber),
		existingBlock(blockLoc("falloutscrubber")));

	layeredItem(NuclearScienceItems.ITEMS_RADIATION_SHIELDING.getValue(SubtypeRadiationShielding.door),
		Parent.GENERATED, itemLoc("leadlineddoor"));

	simpleBlockItem(NuclearScienceBlocks.BLOCKS_RADIATION_SHIELDING.getValue(SubtypeRadiationShielding.trapdoor),
		existingBlock(blockLoc("radiationshieldingtrapdoor_bottom")));
	layeredItem(NuclearScienceItems.ITEMS_REACTORLOGISTICSCABLE.getValue(SubtypeReactorLogisticsCable.base),
		Parent.GENERATED, itemLoc("pipe/" + SubtypeReactorLogisticsCable.base.tag()));
	simpleBlockItem(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.controlrodmodule),
		existingBlock(blockLoc("controlrodmoduleitem")));
	simpleBlockItem(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.fissioninterface),
		existingBlock(blockLoc("fissioninterfaceitem")));
	simpleBlockItem(NuclearScienceBlocks.BLOCKS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.msinterface),
		existingBlock(blockLoc("msinterfaceitem")));
