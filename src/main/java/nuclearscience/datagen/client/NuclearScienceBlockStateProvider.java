...
public class NuclearScienceBlockStateProvider extends BaseBlockstateProvider {
	...
	protected void registerStatesAndModels() {
        ...
        simpleBlock(NuclearScienceBlocks.BLOCKS_RADIATION_SHIELDING.getValue(SubtypeRadiationShielding.glass), blockLoc("leadlinedglass"), true);
        ...
        simpleBlock(NuclearScienceBlocks.BLOCKS_ELECTROMAGENT.getValue(SubtypeElectromagent.electromagneticglass), blockLoc("electromagneticglass"), true);
    ...
    private void genLogisticsCables() {
        ...
        for (SubtypeReactorLogisticsCable cable : SubtypeReactorLogisticsCable.values()) {
            wire(
                    ...
                    //
                    models().withExistingParent(name + cable.tag() + "_none", modLoc(parent + "logisticscable_none")).texture("texture", blockLoc(texture + cable.tag() + "_none")).texture("particle", STEEL_CASING),
                    //
                    models().withExistingParent(name + cable.tag() + "_side", modLoc(parent + "logisticscable_side")).texture("texture", blockLoc(texture + cable.tag() + "_side")).texture("particle", STEEL_CASING),
                    //
                    false);
        }
